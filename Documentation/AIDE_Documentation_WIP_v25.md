...
| Orchestration Design v5 (Decisions v5, UseCases v2) | Dispatch model, ownership narrowing, full dispatch/result contract, 48 decisions | **Accepted** — four rounds + acceptance check (29 findings resolved). 2026-09-17. Pending deployment |
