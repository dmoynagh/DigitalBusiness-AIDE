...
> **Binder Version 4** (2026-09-02). Adds aggregate Update orchestration and advances per-artefact Migration contracts.
...
- `Capabilities_Migration_Definition_v3.md` — sha256 `dfc15cf211f3`
...
<!-- BEGIN SOURCE: Capabilities_Migration_Definition_v3.md -->
...
<!-- END SOURCE: Capabilities_Migration_Definition_v3.md -->
