...
> **Binder Version 8** (2026-09-03). Review D R2 closing correction: current Capability Build Tool family and exact Tools Production checkpoint.
...
- `Capabilities_Tools_Definition_v6.md` — sha256 `d75e8192884a`
- `Capabilities_Tools_Brief_v7.md` — sha256 `4ab2dfe2bfac`
- `Capabilities_Tools_Design_v8.md` — sha256 `6fbbf08cc9f4`
...
<!-- BEGIN SOURCE: Capabilities_Tools_Definition_v6.md -->
# Tools — Capability Definition

> **Version 6** (2026-09-03). Re-evaluates Tools Production against the Review D R2-corrected Tools Design; no Element or Capability release changes.
...
Element releases remain unchanged. Definition document v6 advances only the mutable production
checkpoint after the Tools Design v8 current-reference correction; it does not create `Tools@v6`
or another Element release.
...
ElementProduction:
  Tools.Production:
    EvaluatedInputs: {Capabilities_Tools_Design: v8, AIDE_DocumentationMethodology: v28}
    LastEvaluated: 2026-09-03
    Result: CurrentAtElementRelease-v2
...
---
Dependencies: !AIDE_DocumentationMethodology@v28, AIDE_Capability@v3, AIDE_Dependencies@v3, AIDE_Migration@v3
References: Capabilities_Tools_Design_v8, AIDE_ToolsProduction@v3, AIDE_BuildCapabilityTool@v6, AIDE_CapabilityBuilderTool@v4
<!-- END SOURCE: Capabilities_Tools_Definition_v6.md -->
...
<!-- BEGIN SOURCE: Capabilities_Tools_Design_v8.md -->
# Capabilities Tools — Design

> **Version 8** (2026-09-03). Review D R2 closing correction: aligns the current Capability Build Tool family and v3 migration-checkpoint wording.
...
- `AIDE_BuildCapabilityTool@v6` — Build request/readiness/WorkPackage orchestration with effective Build Target Profile/Definition resolution.
- `AIDE_CapabilityBuilderTool@v4` — Build-side specialised executor producing complete applicable target contributions in the immutable Registry-compatible Capability Package.

`AIDE_BuildCapabilityTool@v2` remains historical and requires explicit migration. v3 is the
Required transition checkpoint; calls retaining Build-request orchestration use the current Tool
release rather than being pinned to historical v3. Tool Element production uses `AIDE_ToolsProduction@v3`.
...
<!-- END SOURCE: Capabilities_Tools_Design_v8.md -->
