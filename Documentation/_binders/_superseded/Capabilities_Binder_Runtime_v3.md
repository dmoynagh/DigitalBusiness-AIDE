...
> **Binder Version 3** (2026-09-02). Closes the Registry post-Build seam for Tags, Scope, Dependencies and Migration Definitions; canonical outcomes remain unchanged.

This Binder is a current-context consumption artefact; authoritative masters remain individual files.

## Binder manifest

- `Capabilities_Tags_Definition_v2.md` — sha256 `4abb265a5346`
- `Capabilities_Tags_Design_v2.md` — sha256 `6a1908a75741`
- `AIDE_Tags_Standard_v2.md` — sha256 `881e15326d8e`
- `Capabilities_Scope_Definition_v2.md` — sha256 `6b21e114d64b`
- `Capabilities_Scope_Design_v2.md` — sha256 `fc8746013c21`
- `AIDE_Scope_Standard_v2.md` — sha256 `5de007fa5a55`
- `Capabilities_Dependencies_Definition_v2.md` — sha256 `5b365783554f`
- `Capabilities_Dependencies_Design_v3.md` — sha256 `ee8326b631be`
- `AIDE_Dependencies_Standard_v3.md` — sha256 `87e82ecc7474`
- `Capabilities_Migration_Definition_v2.md` — sha256 `a627d13fa20a`
- `Capabilities_Migration_Brief_v2.md` — sha256 `a6dcb9d1e8f0`
- `Capabilities_Migration_Design_v2.md` — sha256 `0092b28f02f5`
- `AIDE_Migration_Standard_v2.md` — sha256 `3b7e6bfd2bfe`
- `Capabilities_Migration_Tool_Design_v2.md` — sha256 `e2b78fb444c4`
- `AIDE_Migration_Tool_v2.md` — sha256 `2d1a31518b24`

---

<!-- BEGIN SOURCE: Capabilities_Tags_Definition_v2.md -->
...
|---|---|---|---:|
| `Tags.Standard` | Standard | `AIDE_Tags@v2` | v1 |
...
|---|---|---|
| `Tags.Standard` | Current sources/contracts identified by Definition references | 2026-09-02 baseline |
...
References: Capabilities_Tags_Design_v2, AIDE_Tags@v2, AIDE_DeploymentRegistryTool@v1
<!-- END SOURCE: Capabilities_Tags_Definition_v2.md -->

---

<!-- BEGIN SOURCE: Capabilities_Tags_Design_v2.md -->
# Capabilities Tags — Design

> **Version 2** (2026-09-01). Makes generated-tag freshness a deterministic Tags-owned publication/reliance rule without introducing a generic orchestration engine.
...
References: Capabilities_Scope_Design_v2, Capabilities_Dependencies_Design_v3
<!-- END SOURCE: Capabilities_Tags_Design_v2.md -->
...
<!-- BEGIN SOURCE: Capabilities_Scope_Definition_v2.md -->
...
---
Dependencies: !AIDE_DocumentationMethodology@v27, AIDE_Capability@v2, AIDE_Dependencies@v3, AIDE_Migration@v2
References: Capabilities_Scope_Design_v2, AIDE_Scope@v2, AIDE_DeploymentRegistryTool@v1
<!-- END SOURCE: Capabilities_Scope_Definition_v2.md -->

---

<!-- BEGIN SOURCE: Capabilities_Scope_Design_v2.md -->
# Capabilities Scope — Design

> **Version 2** (2026-09-01). Clarifies that deterministic Machine Scope requires current generated-tag state and consumes AIDE_Tags freshness rather than owning another freshness mechanism.
...
---
Dependencies: !AIDE_DocumentationMethodology@v26, Capabilities_Design_v10, Capabilities_Decisions_v16, Capabilities_Tags_Design_v2
References: AIDE_Tags@v2
<!-- END SOURCE: Capabilities_Scope_Design_v2.md -->
...
<!-- BEGIN SOURCE: Capabilities_Dependencies_Definition_v2.md -->
...
<!-- END SOURCE: Capabilities_Dependencies_Definition_v2.md -->
...
<!-- BEGIN SOURCE: Capabilities_Migration_Definition_v2.md -->
...
<!-- END SOURCE: Capabilities_Migration_Definition_v2.md -->

---

<!-- BEGIN SOURCE: Capabilities_Migration_Brief_v2.md -->
...
<!-- END SOURCE: Capabilities_Migration_Brief_v2.md -->

---

<!-- BEGIN SOURCE: Capabilities_Migration_Design_v2.md -->
# Capabilities Migration — Design

> **Version 2** (2026-09-01). Aligns migration ordering and exact-version handling with Review C: checkpoints are non-ordering and failed exact pins are present dependency blocks, not migration gaps.
...
- `AIDE_Migration@v2`; and
- `Capabilities_Migration_Tool_Design_v2`.
...
---
Dependencies: !AIDE_DocumentationMethodology@v26, Capabilities_Design_v10, Capabilities_Decisions_v16, AIDE_Dependencies@v3, AIDE_Scope@v2
References: Capabilities_Migration_Brief_v2
<!-- END SOURCE: Capabilities_Migration_Design_v2.md -->
...
<!-- BEGIN SOURCE: Capabilities_Migration_Tool_Design_v2.md -->
# Capabilities Migration Tool — Design

> **Version 2** (2026-09-01). Consumes AIDE_Migration@v2 exact-constraint and non-ordering checkpoint semantics.

---

## §1 — Output and boundary

This Design produces one canonical **Migration Tool**. It orchestrates `AIDE_Migration@v2` against
...
---
Dependencies: !AIDE_DocumentationMethodology@v26, AIDE_Migration@v2, Capabilities_Migration_Design_v2, AIDE_Dependencies@v3
References: Capabilities_Tools_Design_v3
<!-- END SOURCE: Capabilities_Migration_Tool_Design_v2.md -->
