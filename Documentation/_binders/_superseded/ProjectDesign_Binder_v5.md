...
> **Binder Version 5** (2026-09-02). Adds Design/Brief Summary depth and the Summary-to-Overview escalation rule.

This Binder is a current-context consumption artefact; authoritative masters remain individual files.

## Binder manifest

- `ProjectDesign_Index_v6.md` — sha256 `73ab14252a1e`
- `ProjectDesign_Design_v6.md` — sha256 `7228853eedb4`
- `ProjectDesign_Decisions_v5.md` — sha256 `ad7f2b358062`
- `AIDE_ProjectDesign_Standard_v6.md` — sha256 `b33781fa444d`

---

<!-- BEGIN SOURCE: ProjectDesign_Index_v6.md -->
...
<!-- END SOURCE: ProjectDesign_Index_v6.md -->

---

<!-- BEGIN SOURCE: ProjectDesign_Design_v6.md -->
...
<!-- END SOURCE: ProjectDesign_Design_v6.md -->
