...
> **Binder Version 6** (2026-09-02). Adds value-based Contents/Summary production for substantial canonical Standards and Tools.

This Binder is a current-context consumption artefact; authoritative masters remain individual files.

## Binder manifest

- `Capabilities_Standards_Definition_v3.md` — sha256 `c3b6e83c8d09`
...
- `Capabilities_Tools_Definition_v4.md` — sha256 `d079777ba61e`
...
- `Capabilities_BuildCapability_Tool_Design_v5.md` — sha256 `6b514a71f422`
- `AIDE_BuildCapability_Tool_v5.md` — sha256 `ead440053f6d`
- `Capabilities_CapabilityBuilder_Tool_Design_v3.md` — sha256 `7696c7635d72`
- `AIDE_CapabilityBuilder_Tool_v3.md` — sha256 `822c1e6e2ab0`

---

<!-- BEGIN SOURCE: Capabilities_Standards_Definition_v3.md -->
# Standards — Capability Definition

> **Version 3** (2026-09-02). Releases Standard production orientation semantics from Documentation Methodology v28.
...
|---|---|---|
| `Standards.Production` | Current sources/contracts identified by Definition references | 2026-09-02 release v2 |
...
References: Capabilities_Standards_Design_v8, AIDE_StandardsProduction@v4, AIDE_StandardsUsage@v2, AIDE_DeploymentRegistryTool@v1
<!-- END SOURCE: Capabilities_Standards_Definition_v3.md -->
...
<!-- BEGIN SOURCE: Capabilities_Tools_Definition_v4.md -->
# Tools — Capability Definition

> **Version 4** (2026-09-02). Releases Tool production orientation semantics from Documentation Methodology v28.
...
| Element | Production inputs | LastEvaluated |
|---|---|---|
| `Tools.Production` | Current sources/contracts identified by Definition references | 2026-09-02 release v2 |
...
---
Dependencies: !AIDE_DocumentationMethodology@v28, AIDE_Capability@v2, AIDE_Dependencies@v3, AIDE_Migration@v3
References: Capabilities_Tools_Design_v7, AIDE_ToolsProduction@v3, AIDE_BuildCapabilityTool@v5, AIDE_CapabilityBuilderTool@v3, AIDE_DeploymentRegistryTool@v1
<!-- END SOURCE: Capabilities_Tools_Definition_v4.md -->
...
<!-- BEGIN SOURCE: Capabilities_BuildCapability_Tool_Design_v5.md -->
...
<!-- END SOURCE: Capabilities_BuildCapability_Tool_Design_v5.md -->
...
<!-- BEGIN SOURCE: Capabilities_CapabilityBuilder_Tool_Design_v3.md -->
...
<!-- END SOURCE: Capabilities_CapabilityBuilder_Tool_Design_v3.md -->
