...
> **Binder Version 6** (2026-09-02). Closes exact Set releases, Deployment Outputs, Delivery Actions, Target Adapters, layered verification and the concrete AIDE Core configuration.

This Binder is a current-context consumption artefact; authoritative masters remain individual files.

## Binder manifest

- `AIDeployment_Index_v6.md` — sha256 `291b0e553978`
- `AIDeployment_Design_v6.md` — sha256 `c5271c3e8602`
- `AIDeployment_Decisions_v6.md` — sha256 `ab3fbe25d095`
- `AIDeployment_Registry_Design_v2.md` — sha256 `583e1bfcac0a`
- `AIDeployment_SetRelease_Design_v1.md` — sha256 `ca0de8abfa80`
- `AIDeployment_TargetAdapter_Design_v1.md` — sha256 `97e17c86f680`
- `AIDeployment_AIDECore_Reference_v1.md` — sha256 `eaed98b06782`
...
<!-- BEGIN SOURCE: AIDeployment_Index_v6.md -->
# AI Deployment — Index

> **Version 6** (2026-09-02). Closes exact Set releases, Outputs, Delivery Actions, Target Adapters and the concrete AIDE Core configuration.
>
...
|---|---:|---|---|
| `AIDeployment_Index` | v6 | Index | Current |
| `AIDeployment_Design` | v6 | Design | Current |
| `AIDeployment_Decisions` | v6 | Decisions | Current |
| `AIDeployment_Registry_Design` | v2 | Design | Current |
| `AIDeployment_SetRelease_Design` | v1 | Design | Current |
| `AIDeployment_TargetAdapter_Design` | v1 | Design | Current |
| `AIDeployment_AIDECore_Reference` | v1 | Reference/configuration | Current |
| `AIDeployment_OpenAI_Reference` | v3 | Reference | Current empirical baseline |
| `AIDE_Deployment_Standard` | v6 | Standard | Current; identity `AIDE_Deployment@v6` |
| `AIDE_Deployment_Tool` | v6 | Tool | Current; identity `AIDE_DeploymentTool@v6` |
| `AIDE_DeploymentRegistry_Tool` | v1 | Tool | Current; identity `AIDE_DeploymentRegistryTool@v1` |

## Binder boundary

`AIDeployment_Binder_v6` is the current generated top-level consumption Binder. Live state remains
separate.
...
The generic design required for the confirmed AIDE Core outcome is closed: Registry supply resolves
through `AIDE_Core` into one immutable `AIDE_Core@vN`, four final Outputs, configured Delivery
...
---
Dependencies: !AIDE_DocumentationMethodology@v27, AIDE_Deployment@v6, AIDE_Build@v8
References: AIDeployment_Registry_Design_v2, AIDeployment_SetRelease_Design_v1, AIDeployment_TargetAdapter_Design_v1, AIDeployment_AIDECore_Reference_v1, AIDE_DeploymentRegistryTool@v1, AIDE_CapabilityBuild@v3, AIDE_Dependencies@v3, AIDE_Tags@v2
<!-- END SOURCE: AIDeployment_Index_v6.md -->

---

<!-- BEGIN SOURCE: AIDeployment_Design_v6.md -->
...
<!-- END SOURCE: AIDeployment_Design_v6.md -->

---

<!-- BEGIN SOURCE: AIDeployment_Decisions_v6.md -->
...
<!-- END SOURCE: AIDeployment_Decisions_v6.md -->
...
<!-- BEGIN SOURCE: AIDeployment_SetRelease_Design_v1.md -->
...
<!-- END SOURCE: AIDeployment_SetRelease_Design_v1.md -->
...
<!-- BEGIN SOURCE: AIDeployment_AIDECore_Reference_v1.md -->
# AIDE Core Deployment — Reference Configuration

> **Version 1** (2026-09-02). Initial concrete Profile/Set/output/action/Target configuration for AIDE Core.
...
DeliveryActions:
  ...
  PublishAIDECoreBundles:
    ...
    Channel: LocalFile
    Destination: 'C:\Users\david\dev\repos\Documentation\DeployedBundles'
    SupersededDestination: 'C:\Users\david\dev\repos\Documentation\DeployedBundles\superseded'
...
---
Dependencies: !AIDE_DocumentationMethodology@v27, AIDE_Deployment@v6, AIDE_CapabilityBuild@v3
References: Capabilities_AIDECore_BuildTargetProfile_v1, AIDeployment_SetRelease_Design_v1, AIDeployment_TargetAdapter_Design_v1, AIDeployment_OpenAI_Reference_v3
<!-- END SOURCE: AIDeployment_AIDECore_Reference_v1.md -->
