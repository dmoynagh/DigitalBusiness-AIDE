...
- `DocumentationMethodology_Index_v4.md` — sha256 `6c67a97ba889`
- `DocumentationMethodology_Design_v16.md` — sha256 `2cf917d2e83a`
- `DocumentationMethodology_Decisions_v17.md` — sha256 `66bc020d5c27`
- `AIDE_DocumentationMethodology_Standard_v19.md` — sha256 `313363c55837`
- `DocumentationMethodology_Guide_v19.md` — sha256 `d9cec49fe055`

---

<!-- BEGIN SOURCE: DocumentationMethodology_Index_v4.md -->
...
<!-- END SOURCE: DocumentationMethodology_Index_v4.md -->

---

<!-- BEGIN SOURCE: DocumentationMethodology_Design_v16.md -->
# Documentation Methodology — Design

> **Version 16** (2026-08-31). Restores the full Decisions-document contract to the confirmed
> internal model, resolves the downstream-boundary contradiction, and declares the corrected v19
...
- topic/file organisation conventions;
- Index/register behaviour;
- document metadata-container placement and coexistence;
- archive/supersession/no-delete conventions;
...
The governing principle is one owner per mechanism: Documentation Methodology hosts document
structure; semantic owners retain their own behaviour.
...
- Decisions history splits only when retrieval quality deteriorates; prefer closure/state-based
  ...
  active record.
- Working is mutable design-in-progress.
...
v19, subject to `AIDE_Dependencies` semantics.

The v18 transition posture remains `OnUpdate` for v17→v18. The v19 correction is `None`: it
changes the canonical operating contract but requires no structural/content transformation of
...
5. traverse the v19 `None` transition when processing through current; and
...
`AIDE_DocumentationMethodology@v19`:

1. **`AIDE_DocumentationMethodology_Standard_v19.md`**  
...
2. **`DocumentationMethodology_Guide_v19.md`**  
...
For this established methodology lineage, the canonical Standard filename version follows the Documentation Methodology release version so the v19 Standard and v19 Guide are visibly one release.
...
---
Dependencies: !AIDE_DocumentationMethodology@v19, AIDE_Dependencies@v2, AIDE_Migration@v1
References: DocumentationMethodology_Guide_v19, AIDE_StandardsProduction@v1
<!-- END SOURCE: DocumentationMethodology_Design_v16.md -->

---

<!-- BEGIN SOURCE: DocumentationMethodology_Decisions_v17.md -->
...
<!-- END SOURCE: DocumentationMethodology_Decisions_v17.md -->

---

<!-- BEGIN SOURCE: AIDE_DocumentationMethodology_Standard_v19.md -->
# AIDE Documentation Methodology — Standard

> **Identity:** `AIDE_DocumentationMethodology@v19`
...
`DocumentationMethodology_Guide_v19` is its fuller human-oriented companion.
...
Merely reading/using a v17 document does not trigger the v18 OnUpdate transition. v19 requires no
additional artefact transformation; when Migration traverses through current during a qualifying
save, the v19 None transition may advance the saved checkpoint through v19 after the v18 success
...
References: DocumentationMethodology_Design_v16, DocumentationMethodology_Guide_v19
<!-- END SOURCE: AIDE_DocumentationMethodology_Standard_v19.md -->

---

<!-- BEGIN SOURCE: DocumentationMethodology_Guide_v19.md -->
# Documentation & Workflow Methodology — Guide

> **Identity:** `AIDE_DocumentationMethodology@v19`
> **v19** (2026-08-31). Corrects the canonical Decisions-document contract, makes substantive
> Design/Decisions same-pass preservation explicit, clarifies proportionality, and removes a
> downstream-boundary contradiction.
>
> **Migration posture:** None for v19. Existing v18-conformant documents require no structural or
> content migration merely because of this correction. The v18 OnUpdate transition remains in the
> retained history for v17→v18.
>
> v18 remains the historical predecessor. All v18 rules remain in force unless this release states
> a replacement or clarification.
...
Dependencies: !AIDE_DocumentationMethodology@v19, abc_Design@v5
...
v19 changes the operating contract for future documentation work but does not require existing
v18-conformant documents or historical Decisions entries to be rewritten. On a later qualifying
save, normal Migration/Dependencies processing may advance the saved checkpoint through v19 after
any earlier applicable transition work is satisfied.
---
Dependencies: AIDE_Dependencies@v2, AIDE_Migration@v1, AIDE_Tags@v1, AIDE_WorkPackage@v1
References: Core_System_Design_v4
<!-- END SOURCE: DocumentationMethodology_Guide_v19.md -->
