...
> **Binder Version 3** (2026-09-01). Assembles the v22 Review A seam/WIP reconciliation masters.

## Binder manifest

- `DocumentationMethodology_Index_v7.md` — sha256 `1d1cf503c18b`
- `DocumentationMethodology_Design_v19.md` — sha256 `f43faac818f9`
- `DocumentationMethodology_Decisions_v20.md` — sha256 `059b92767439`
- `AIDE_DocumentationMethodology_Standard_v22.md` — sha256 `6950cde3e751`
- `DocumentationMethodology_Guide_v22.md` — sha256 `e042a30169e6`

---

<!-- BEGIN SOURCE: DocumentationMethodology_Index_v7.md -->
...
<!-- END SOURCE: DocumentationMethodology_Index_v7.md -->

---

<!-- BEGIN SOURCE: DocumentationMethodology_Design_v19.md -->
# Documentation Methodology — Design

> **Version 19** (2026-09-01). Clarifies `DocumentationTopic` as the logical top-level-topic
> boundary declared by its governing Index and establishes one WIP continuation series per
> top-level topic.
>
...
v18 remains `OnUpdate`; v19/v20/v21/v22 are `None` transitions.

v21 changed the canonical operating model without requiring mass rewriting/renaming. v22 clarifies
`DocumentationTopic` recognition and corrects the WIP-series rule prospectively. It does not require
historical/superseded WIP renames or a corpus-wide rewrite; current material adopts v22 semantics on
its next qualifying substantive update/save under normal Dependencies/Migration behaviour.
...
References: DocumentationMethodology_Decisions_v20, WorkingPractices_Design_v5, AIDE_WorkPackage@v2
<!-- END SOURCE: DocumentationMethodology_Design_v19.md -->

---

<!-- BEGIN SOURCE: DocumentationMethodology_Decisions_v20.md -->
# Documentation Methodology — Decisions

> **Version 20** (2026-09-01). Preserves the complete prior decision history and records the
> Review A `DocumentationTopic` seam clarification plus the single top-level-topic WIP-series rule.
>
> Created: 2026-08-30 | Last modified: 2026-09-01
...
---
Dependencies: !AIDE_DocumentationMethodology@v22, AIDE_Index@v1, DocumentationMethodology_Design_v19
References: DocumentationMethodology_Guide_v22, Core_Index_Decisions_v1, WorkingPractices_Decisions_v5, AIDE_WorkPackage@v2
<!-- END SOURCE: DocumentationMethodology_Decisions_v20.md -->

---

<!-- BEGIN SOURCE: AIDE_DocumentationMethodology_Standard_v22.md -->
# AIDE Documentation Methodology — Standard

> **Identity:** `AIDE_DocumentationMethodology@v22`
> **Common name:** Documentation Methodology
> **Version 22**
> > **Published:** 2026-09-01
> > **Change:** Review A `DocumentationTopic` seam clarification and one WIP series per top-level topic.
>
...
`DocumentationMethodology_Guide_v22` is its fuller human-oriented companion.
...
carry their identity inside the WIP using concise sections or equivalent internal structure. This
rule is specific to WIP and does not remove legitimate subtopic-specific Working documents or
...
resumption, increment `_vN` in this single series so the filename visibly signals currency. A
replaced issued checkpoint becomes Superseded.
...
`Live state` series/locator entry (for example `Capabilities_WIP`). The current checkpoint
...
Merely reading/using a v17 document does not trigger the v18 OnUpdate transition. v19, v20, v21 and
v22 require no additional artefact transformation; when Migration traverses through current during
...
rewrites; the corrected root-WIP convention applies prospectively to current/new checkpoints.
...
References: DocumentationMethodology_Design_v19, DocumentationMethodology_Guide_v22
<!-- END SOURCE: AIDE_DocumentationMethodology_Standard_v22.md -->

---

<!-- BEGIN SOURCE: DocumentationMethodology_Guide_v22.md -->
# Documentation & Workflow Methodology — Guide

> **Identity:** `AIDE_DocumentationMethodology@v22`
> **Version 22** (2026-09-01). Human-oriented companion clarifying the logical
> `DocumentationTopic` boundary and the single top-level-topic WIP-series convention while carrying
> forward the v21 operating model.
>
> **Migration posture:** None for v22. Existing governed documents do not require mass rewrite or
> rename solely because this release clarifies the semantic boundary and WIP-series convention.
...
When an existing governed document is next substantively updated, use the current v22 model under
normal Dependencies/Migration behaviour.
...
References: DocumentationMethodology_Design_v19, AIDE_DocumentationMethodology@v22, WorkingPractices_Design_v5
<!-- END SOURCE: DocumentationMethodology_Guide_v22.md -->
