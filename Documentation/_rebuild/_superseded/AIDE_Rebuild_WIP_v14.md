...
> **Version 14** (2026-09-07). Project Design design review, stages 4 and 5 largely
> complete — see §15c. Settled this pass: the component-ownership boundary reworked
...
- **Item 8 progress** — per-component design review: the six-stage procedure, three-layer authoring model, Principles (complete), Project Design (stages 1–5, design pass open).
...
**Two placement tensions named** — these are where capture-and-place will have
to decide, so both need a clean test or items will land in two places:

- **Objectives vs requirements.** Proposed test: *an objective is what success
  looks like; a requirement is a condition the solution must meet to get there.*
  "Fast" is an objective; "responds within two seconds" is a requirement.
...
- **Brief-to-design delivery and elasticity**; the **commitment-and-return
  loop**.
...
**Status: stages 1–5 substantially complete. Design pass open at capture-and-place, then stage 6 (blocked on Standards).**
