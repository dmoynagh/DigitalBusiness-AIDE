...
- **Item 8 progress** — per-component design review: the six-stage procedure, three-layer authoring model, Principles (complete), Project Design (forward design pass complete; **binder sweep part 1 — omissions — complete**; part 2 (approach), the four binder-editing items and the Standards-blocked stage 6 remain).
...
required in substance.)* The brief scales by which sections are present and how
...
- **Binder sweep part 2 — approach.** Part 1 (omissions) is **complete**; see the
  ...
  still fit the design it now has to express. **Recommended first: define *design
  project* and *build project*,** which part 2 will hit immediately and on which
  the new brief property depends. **Moderate.**
- **Three open items named by part 1 and not yet worked:** whether AIDE uses the
  concept of **domains** (blocking one parked sweep finding); the definitions of
  **design project** and **build project**; and whether "a brief is the root of a
  design" adds a hierarchy claim or restates settled material.
