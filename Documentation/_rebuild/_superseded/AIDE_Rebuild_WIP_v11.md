...
> **Version 11** (2026-09-07). Item 7 naming pass complete. The final open question —
> whether the Capabilities grouping earns a purpose line — was worked and confirmed:
> it stays a container, not a component, until a demonstrated need forces otherwise
> (provisional; no container-tree or ownership consequences decided in this pass).
> Next step reframed: a per-component design and purpose review, in chat, one
> component at a time — flesh out purpose, check approach and design against current
> ways of working and learnings, confirm each is more than a migration gate. Working
> document — does not conform to the full documentation methodology by design.
...
8. Per-component design and purpose review — in chat, one component at a time. For
   ...
   Run the documentation_old filter per component as part of this pass.
