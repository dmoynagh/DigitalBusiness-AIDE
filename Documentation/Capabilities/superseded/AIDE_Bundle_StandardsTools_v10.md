...
> **Version 10** (2026-09-03). Review D R1 remediation: exact Capability production inputs, frozen Tags, Deployment v7/Registry v2, Build v9 post-Build workflow state and repository-relative Change Delivery.
