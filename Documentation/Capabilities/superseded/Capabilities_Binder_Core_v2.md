...
> **Binder Version 2** (2026-08-31). Registers Messaging as the eighth peer capability, Review v2 integration, and the post-Messaging peer-Review priority.

This Binder is a project-context consumption artefact; authoritative masters remain individual files.

## Binder manifest

- `Capabilities_Index_v16.md` — sha256 `6c5b1f6c5e23`
- `Capabilities_Brief_v8.md` — sha256 `72288a6cb9c5`
- `Capabilities_Overview_v14.md` — sha256 `ecccaf9309be`
- `Capabilities_Design_v9.md` — sha256 `716e00ef7772`
- `Capabilities_Decisions_v15.md` — sha256 `944aa2c09685`

---

<!-- BEGIN SOURCE: Capabilities_Index_v16.md -->
# Capabilities — Index
...
<!-- END SOURCE: Capabilities_Index_v16.md -->

---

<!-- BEGIN SOURCE: Capabilities_Brief_v8.md -->
# Capabilities — Brief

> **Version 8** (2026-08-31). Adds Messaging as the eighth peer Capabilities component,
> resolves Review's shared communication seam to Messaging, and adopts the current
> Documentation Methodology v21 live-state boundary.
>
> Created: 2026-08-27 | Last modified: 2026-08-31
...
retrieval. Documentation Methodology supplies the generic governed-document mechanics.
...
**Depends on:** `Capabilities_Decisions` v15.

References: `Capabilities_Design` v9, `Capabilities_Migration_Design` v1,
...
<!-- END SOURCE: Capabilities_Brief_v8.md -->

---

<!-- BEGIN SOURCE: Capabilities_Overview_v14.md -->
...
Dependencies: !AIDE_DocumentationMethodology@v21
<!-- END SOURCE: Capabilities_Overview_v14.md -->

---

<!-- BEGIN SOURCE: Capabilities_Design_v9.md -->
# Capabilities — Design

> **Version 9** (2026-08-31). Adds Messaging as the eighth peer capability, resolves the
> Review communication seam to Messaging, and adopts the confirmed conversation/WIP/OpenItems/
> persisted-Message state model without a dedicated obligations register.
>
> Created: 2026-08-27 | Last modified: 2026-08-31
...
Detailed contract: `Capabilities_Review_Design` v2, `AIDE_Review@v2`,
`AIDE_ReviewProfiles@v1`, `Capabilities_Review_Tool_Design` v2, and canonical
`AIDE_ReviewTool@v2`.
...
identifiers are mismatch signals; absence proves nothing.
...
The canonical outcomes are `AIDE_Messaging@v1` and `AIDE_MessagingTool@v1`. Platform skills,
...
Detailed contract: `Capabilities_Messaging_Design` v1,
`Capabilities_Messaging_Tool_Design` v1, `AIDE_Messaging@v1`, and `AIDE_MessagingTool@v1`.
...
**Depends on:** `Capabilities_Brief` v8, `Capabilities_Decisions` v15.
...
`Capabilities_Review_Design` v2, `Capabilities_Messaging_Design` v1,
`Capabilities_BuildCapability_Tool_Design` v1,
`Core_System_Design` v4.

Dependencies: !AIDE_DocumentationMethodology@v21
<!-- END SOURCE: Capabilities_Design_v9.md -->

---

<!-- BEGIN SOURCE: Capabilities_Decisions_v15.md -->
# Capabilities — Decisions

> **Version 15** (2026-08-31). Adds Messaging as the eighth peer Capabilities component,
> resolves Review's communication-owner seam to Messaging, and records the no-register persistence
> and Build/Bootstrap boundary confirmed in the Messaging reconciliation.
>
> Created: 2026-08-27 | Last modified: 2026-08-31
...
References: Capabilities_Messaging_Design_v1, Capabilities_Review_Design_v2, AIDE_Messaging@v1, AIDE_Review@v2
<!-- END SOURCE: Capabilities_Decisions_v15.md -->
