...
> **Binder Version 1** (2026-08-31). First independently versioned Core split-Binder; adopts Core Index, records the queued Messaging integration direction, and keeps live work state separate.

This Binder is a project-context consumption artefact; authoritative masters remain individual files.

## Binder manifest

- `Capabilities_Index_v15.md` — sha256 `594a8b3e2b4c`
- `Capabilities_Brief_v7.md` — sha256 `344d4666fb9e`
- `Capabilities_Overview_v13.md` — sha256 `cc58e9080e9f`
- `Capabilities_Design_v8.md` — sha256 `7892521a0c2b`
- `Capabilities_Decisions_v14.md` — sha256 `f41f8a47c11b`

---

<!-- BEGIN SOURCE: Capabilities_Index_v15.md -->
# Capabilities — Index
...
<!-- END SOURCE: Capabilities_Index_v15.md -->

---

<!-- BEGIN SOURCE: Capabilities_Brief_v7.md -->
# Capabilities — Brief

> **Version 7** (2026-08-30). Promotes generic AI/platform Deployment out of
> Capabilities while retaining capability-local Package and logical deployment-intent production.
...
References: `Capabilities_Design` v8, `Capabilities_Migration_Design` v1,
`Capabilities_Standards_Design` v4, `Capabilities_Tools_Design` v2.

Dependencies: !AIDE_DocumentationMethodology@v18
<!-- END SOURCE: Capabilities_Brief_v7.md -->

---

<!-- BEGIN SOURCE: Capabilities_Overview_v13.md -->
...
Dependencies: !AIDE_DocumentationMethodology@v18
<!-- END SOURCE: Capabilities_Overview_v13.md -->

---

<!-- BEGIN SOURCE: Capabilities_Design_v8.md -->
# Capabilities — Design
...
Dependencies: !AIDE_DocumentationMethodology@v18
<!-- END SOURCE: Capabilities_Design_v8.md -->

---

<!-- BEGIN SOURCE: Capabilities_Decisions_v14.md -->
# Capabilities — Decisions

> **Version 14** (2026-08-30). Records promotion of generic Deployment out of
> Capabilities, closes the tested local OpenAI shared-route hypothesis, and closes the DocMeth handoff.
> Capability as a Tool, formalises `Tool` as the published invokable-outcome type, and closes the
> missing Standards Production/Usage and Review/Migration/Build Capability canonical outcomes.
> Deployment remains deliberately open. Earlier decisions remain as design history and are
> superseded where stated below.
>
> Created: 2026-08-27 | Last modified: 2026-08-30
...
---
Dependencies: !AIDE_DocumentationMethodology@v18, Capabilities_Review_Decisions_v1
References: Core_System_Design_v4, Capabilities_Design_v8, AIDeployment_Design_v1
<!-- END SOURCE: Capabilities_Decisions_v14.md -->
