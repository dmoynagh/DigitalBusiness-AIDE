...
> **Binder Version 5** (2026-09-01). Post-Review-C completion issue: updates only the Capabilities Index/current Review-programme state after successful R3 verification; the Review-C-verified semantic architecture is unchanged.

This Binder is a project-context consumption artefact; authoritative masters remain individual files.

## Binder manifest

- `Capabilities_Index_v19.md` — sha256 `5db0a87aaa50`
...
<!-- BEGIN SOURCE: Capabilities_Index_v19.md -->
# Capabilities — Index
...
<!-- END SOURCE: Capabilities_Index_v19.md -->
