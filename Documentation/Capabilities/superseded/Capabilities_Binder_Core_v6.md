...
> **Binder Version 6** (2026-09-02). Reconciles the parent Capability/Definition/Element/release and specialised Capability Build architecture.

This Binder is a current-context consumption artefact; authoritative masters remain individual files.

## Binder manifest

- `Capabilities_Index_v20.md` — sha256 `338f8575f81b`
- `Capabilities_Brief_v11.md` — sha256 `decb32845e2b`
- `Capabilities_Overview_v17.md` — sha256 `a8793fdf41c4`
- `Capabilities_Design_v12.md` — sha256 `926a0dfa290d`
- `Capabilities_Decisions_v17.md` — sha256 `3ae0e518b067`
- `Capabilities_Capability_Design_v1.md` — sha256 `6af4c8c6c0a0`
- `Capabilities_Capability_Decisions_v1.md` — sha256 `da538a5da13a`
- `AIDE_Capability_Standard_v1.md` — sha256 `f793535faf2f`
- `Capabilities_CapabilityBuild_Design_v1.md` — sha256 `08e6bfb85a58`
- `Capabilities_CapabilityBuild_Decisions_v1.md` — sha256 `a2fe67268ea0`
- `AIDE_CapabilityBuild_Standard_v1.md` — sha256 `d33990e65055`

---

<!-- BEGIN SOURCE: Capabilities_Index_v20.md -->

# Capabilities — Index

> **Version 20** (2026-09-02). Registers the reconciled Capability/Element and specialised Capability Build architecture; Review D remains on hold.
...
|---|---|---|
| Standards | `Capabilities_Standards_Definition_v1` | `AIDE_StandardsProduction@v3`, `AIDE_StandardsUsage@v2` |
| Tools | `Capabilities_Tools_Definition_v1` | `AIDE_ToolsProduction@v2`, `AIDE_UpdateCapabilityElementsTool@v1`, `AIDE_BuildCapabilityTool@v3`, `AIDE_CapabilityBuilderTool@v1` |
| Tags | `Capabilities_Tags_Definition_v1` | `AIDE_Tags@v2` |
| Scope | `Capabilities_Scope_Definition_v1` | `AIDE_Scope@v2` |
| Dependencies | `Capabilities_Dependencies_Definition_v1` | `AIDE_Dependencies@v3` |
| Migration | `Capabilities_Migration_Definition_v1` | `AIDE_Migration@v2`, `AIDE_MigrationTool@v2` |
| Review | `Capabilities_Review_Definition_v1` | `AIDE_Review@v3`, `AIDE_ReviewProfiles@v2`, `AIDE_ReviewTool@v3` |
| Messaging | `Capabilities_Messaging_Definition_v1` | `AIDE_Messaging@v2`, `AIDE_MessagingTool@v2` |

### Parent/current architecture documents

| Document | Version | Type | Status |
|---|---:|---|---|
| `Capabilities_Index` | v20 | Index | Current |
| `Capabilities_Brief` | v11 | Brief | Current |
| `Capabilities_Overview` | v17 | Overview | Current human TLDR |
| `Capabilities_Design` | v12 | Design | Current |
| `Capabilities_Decisions` | v17 | Decisions | Current history |
...
| `Capabilities_CapabilityBuild_Design` | v1 | Design | Current |
| `Capabilities_CapabilityBuild_Decisions` | v1 | Decisions | Current |
| `AIDE_CapabilityBuild_Standard` | v1 | Standard | `AIDE_CapabilityBuild@v1` |
...
| Binder | Boundary |
|---|---|
| `Capabilities_Binder_Core_v6` | parent architecture + Capability/Capability Build contracts |
| `Capabilities_Binder_StandardsTools_v3` | Standards/Tools Definitions, production contracts and Capability production/build Tools |
| `Capabilities_Binder_Runtime_v2` | Tags/Scope/Dependencies/Migration Definitions and current outcomes |
| `Capabilities_Binder_Review_v4` | Review Definition and current Review corpus |
| `Capabilities_Binder_Messaging_v4` | Messaging Definition and current Messaging corpus |
...
Reviews A–C are complete at High. Review D is **ON HOLD** pending the active AI Deployment return
handoff and final producer/deployment seam reconciliation. Review E remains later.

---
Dependencies: !AIDE_DocumentationMethodology@v27, AIDE_Capability@v1, AIDE_CapabilityBuild@v1
References: Capabilities_WIP_v18, Capabilities_WorkRegister_v18, Capabilities_OpenItems_v16
<!-- END SOURCE: Capabilities_Index_v20.md -->

---

<!-- BEGIN SOURCE: Capabilities_Brief_v11.md -->

# Capabilities — Brief

> **Version 11** (2026-09-02). Reframes Capabilities around Definition, Elements, specialised Capability Build and the open AI Deployment seam.
...
- every successful Capability Build produces a complete Capability Package; and
- an explicit post-Build Tool handoff, leaving the final Deployment Registry contract to AI Deployment.
...
References: Capabilities_Design_v12, AIDE_Capability@v1, AIDE_CapabilityBuild@v1
<!-- END SOURCE: Capabilities_Brief_v11.md -->

---

<!-- BEGIN SOURCE: Capabilities_Overview_v17.md -->
...
<!-- END SOURCE: Capabilities_Overview_v17.md -->

---

<!-- BEGIN SOURCE: Capabilities_Design_v12.md -->
...
<!-- END SOURCE: Capabilities_Design_v12.md -->

---

<!-- BEGIN SOURCE: Capabilities_Decisions_v17.md -->
# Capabilities — Decisions

> **Version 17** (2026-09-02). Records the Capability Definition/Element release, specialised Build, explicit Tool succession and open Deployment seam decisions.
...
---
Dependencies: !AIDE_DocumentationMethodology@v27, Capabilities_Design_v12
References: Capabilities_Messaging_Design_v2, Capabilities_Review_Design_v3, AIDE_Messaging, AIDE_Review
<!-- END SOURCE: Capabilities_Decisions_v17.md -->

---

<!-- BEGIN SOURCE: Capabilities_Capability_Design_v1.md -->
...
<!-- END SOURCE: Capabilities_Capability_Design_v1.md -->
...
<!-- BEGIN SOURCE: AIDE_Capability_Standard_v1.md -->
...
<!-- END SOURCE: AIDE_Capability_Standard_v1.md -->

---

<!-- BEGIN SOURCE: Capabilities_CapabilityBuild_Design_v1.md -->
...
References: Capabilities_Design_v12
<!-- END SOURCE: Capabilities_CapabilityBuild_Design_v1.md -->

---

<!-- BEGIN SOURCE: Capabilities_CapabilityBuild_Decisions_v1.md -->
...
<!-- END SOURCE: Capabilities_CapabilityBuild_Decisions_v1.md -->

---

<!-- BEGIN SOURCE: AIDE_CapabilityBuild_Standard_v1.md -->
...
<!-- END SOURCE: AIDE_CapabilityBuild_Standard_v1.md -->
