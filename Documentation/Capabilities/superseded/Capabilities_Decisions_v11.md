...
> **Version 11** (2026-08-29). **Review checkpoint.** Finalises Review's purpose, independent
> Type/Level/Mode/Reviewer model, consequence-based dynamic Level, lifecycle and record contracts,
> five Profiles, Tool boundary, scope control, persistence, and external environment /
> communication seams.
...
**References:** `Core_System_Design` v3, `Capabilities_Design` v5,
`Capabilities_Standards_Design` v3 (revision required),
`Capabilities_Tools_Design` v1 (revision required), `Capabilities_Brief` v4,
