...
> **Version 10** (2026-08-28). **Tags, Scope and Dependencies checkpoint.** Adds Tags as an
> eighth peer component, extracts taxonomy/tagging from Scope, finalises the thin Scope model,
> establishes the compact Dependencies/identity/query model and bootstrap relationship, and
> separates the Capability Package payload from Deployment Manifest intent.
