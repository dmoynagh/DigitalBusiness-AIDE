...
> **Binder Version 4** (2026-09-01). Applies the Review C R2 closing reference-position corrections, current runtime-consumer propagation, and Index self-row correction pending bounded R3 verification.

This Binder is a project-context consumption artefact; authoritative masters remain individual files.

## Binder manifest

- `Capabilities_Index_v18.md` — sha256 `2f5fc2b687eb`
- `Capabilities_Brief_v10.md` — sha256 `f962bc921142`
- `Capabilities_Overview_v16.md` — sha256 `09c728f840a2`
- `Capabilities_Design_v11.md` — sha256 `3f5e366f22ea`
- `Capabilities_Decisions_v16.md` — sha256 `a7ddd1589663`

---

<!-- BEGIN SOURCE: Capabilities_Index_v18.md -->
# Capabilities — Index

> **Version 18** (2026-09-01). Records Review C R2 closing remediation, corrects the self-register row, and prepares the bounded R3 criterion check.
...
|---|---:|---|---|---|
| `Capabilities_Index` | v18 | Index | established | Current |
...
1. Complete bounded Review C R3 criterion verification of the R2 closing corrections (`WR17`).
2. Close Review C at High if the four R2 findings verify as resolved.
3. Proceed to Review D — design-to-production.
4. Preserve Review E as the later integrated-coherence gate.

---
Dependencies: !AIDE_DocumentationMethodology@v26, AIDE_Index@v2, Capabilities_Design_v11
References: Capabilities_Overview, Capabilities_Decisions, Capabilities_Messaging_Design, Capabilities_WorkRegister, Capabilities_OpenItems
<!-- END SOURCE: Capabilities_Index_v18.md -->

---

<!-- BEGIN SOURCE: Capabilities_Brief_v10.md -->
# Capabilities — Brief
...
<!-- END SOURCE: Capabilities_Brief_v10.md -->

---

<!-- BEGIN SOURCE: Capabilities_Overview_v16.md -->
# Capabilities — Overview

> **Version 16** (2026-09-01). Applies Review C R2 reference-position cleanup and records the bounded closing remediation before criterion verification.
...
- `AIDE_StandardsProduction`;
- `AIDE_StandardsUsage`;
- `AIDE_ToolsProduction`;
- `AIDE_ReviewTool`;
- `AIDE_MigrationTool`; and
- `AIDE_BuildCapabilityTool`;
- `AIDE_Messaging`; and
- `AIDE_MessagingTool`.
...
`AIDE_Messaging` keeps message identity/threading/readability separate, retains best-effort
...
where positive receipt proof matters. `AIDE_MessagingTool` supplies Compose, Receive, Reply,
Forward, Promote, Acknowledge, QueryReceipt and Reconcile.

Review consumes Messaging for AI-MESSAGE relay/receipt semantics; Review treats Review/Round payload correlation as authoritative for Review semantics and quarantines a positive mismatch with transport correlation. Profiles keeps the same five Types with versionless Review references.
...
---
Dependencies: !AIDE_DocumentationMethodology@v26, Capabilities_Brief_v10, Capabilities_Design_v11, Capabilities_Decisions_v16
References: Capabilities_Migration_Design, Capabilities_Dependencies_Design, Capabilities_WorkRegister, Capabilities_OpenItems, Capabilities_Messaging_Design
<!-- END SOURCE: Capabilities_Overview_v16.md -->

---

<!-- BEGIN SOURCE: Capabilities_Design_v11.md -->
# Capabilities — Design

> **Version 11** (2026-09-01). Self-applies the Review C reference-position rule to current capability locators/inventories while preserving the R1 semantic architecture.
...
behaviour. Its published generic outcomes are `AIDE_StandardsProduction` and
`AIDE_StandardsUsage`.
...
Detailed contract: `Capabilities_Standards_Design`.
...
Tools publishes `AIDE_ToolsProduction` as the generic canonical Tool-production contract.
...
Detailed contract: `Capabilities_Tools_Design`.
...
Detailed contract: `Capabilities_Tags_Design` / `AIDE_Tags`.
...
Detailed contract: `Capabilities_Scope_Design` / `AIDE_Scope`.
...
Detailed contract: `Capabilities_Dependencies_Design` / `AIDE_Dependencies`.
...
Detailed contract: `Capabilities_Migration_Design` / `AIDE_Migration`,
`Capabilities_Migration_Tool_Design`, and canonical `AIDE_MigrationTool`.
...
Capability Design. `AIDE_Deployment` owns Deployment Sets/Targets, representation/channel/
...
Detailed contract: `Capabilities_Review_Design`, `AIDE_Review`,
`AIDE_ReviewProfiles`, `Capabilities_Review_Tool_Design`, and canonical
`AIDE_ReviewTool`.
...
The canonical outcomes are `AIDE_Messaging` and `AIDE_MessagingTool`. Platform skills,
...
Detailed contract: `Capabilities_Messaging_Design`,
`Capabilities_Messaging_Tool_Design`, `AIDE_Messaging`, and `AIDE_MessagingTool`.
...
---
Dependencies: !AIDE_DocumentationMethodology@v26, Capabilities_Brief_v10, Capabilities_Decisions_v16
...
<!-- END SOURCE: Capabilities_Design_v11.md -->
