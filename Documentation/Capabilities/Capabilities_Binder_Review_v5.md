...
> **Binder Version 5** (2026-09-02). Closes the Review Definition Registry post-Build seam; the Review corpus remains otherwise unchanged.

This Binder is a current-context consumption artefact; authoritative masters remain individual files.

## Binder manifest

- `Capabilities_Review_Definition_v2.md` — sha256 `3da6ff35aa47`
...
<!-- BEGIN SOURCE: Capabilities_Review_Definition_v2.md -->
...
<!-- END SOURCE: Capabilities_Review_Definition_v2.md -->
