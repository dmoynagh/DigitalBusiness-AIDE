...
> **Version 13** (2026-08-30). Registers the canonical-output closeout: Standards Production/Usage,
...
|---|---:|---|---|---|
| `Capabilities_Index` | v13 | Index | established | Current |
| `Capabilities_Brief` | v6 | Brief | established | Current |
| `Capabilities_Design` | v7 | Design | established | Current |
| `Capabilities_Decisions` | v13 | Decisions | established | Current |
| `Capabilities_WorkRegister` | v11 | WorkRegister | established | Current |
| `Capabilities_OpenItems` | v13 | OpenItems | established | Current |
| `Capabilities_Overview` | v12 | Overview | established | Current architecture surface |
...
No core non-Deployment canonical capability output remains open in this project.
...
**Depends on:** `Capabilities_Brief` v6, `Capabilities_Design` v7,
`Capabilities_Decisions` v13.

**References:** `Capabilities_Overview` v12, `Capabilities_OpenItems` v13,
`Capabilities_WorkRegister` v11, `Capabilities_DocMethReviewItems` v3.
