...
> **Binder Version 4** (2026-09-01). Review B R2 closing clarification: Project Handoff OpenItem
> closure now explicitly requires routing any confirmed-but-undelivered reconciliation consequence
> to the destination WorkRegister under the existing Documentation Methodology rule.

## Binder manifest

- `WorkingPractices_Index_v7.md` — sha256 `8ef8736e72b5`
- `WorkingPractices_Brief_v5.md` — sha256 `b62ce0e2fa05`
- `WorkingPractices_Design_v7.md` — sha256 `8c7665d0356d`
- `WorkingPractices_Decisions_v6.md` — sha256 `88296a641505`
- `AIDE_WorkingPractices_Standard_v6.md` — sha256 `78975181560d`

---

<!-- BEGIN SOURCE: WorkingPractices_Index_v7.md -->
# Working Practices — Index

> **Version 7** (2026-09-01). Registers the Review B R2 Project Handoff closing clarification.
>
...
| `WorkingPractices_Design` | v7 | Design | Current |
| `WorkingPractices_Decisions` | v6 | Decisions | Current |
| `AIDE_WorkingPractices_Standard` | v6 | Standard | Current; identity `AIDE_WorkingPractices@v1` |
...
References: WorkingPractices_Design_v7, AIDE_WorkingPractices@v1
<!-- END SOURCE: WorkingPractices_Index_v7.md -->
...
<!-- BEGIN SOURCE: WorkingPractices_Design_v7.md -->
# Working Practices — Design

> **Version 7** (2026-09-01). Review B R2 closing clarification: makes deferred Project Handoff
> OpenItem closure explicit about routing any confirmed-but-undelivered consequence through the
> existing destination WorkRegister rule.
>
> Created: 2026-08-31 | Last modified: 2026-09-01
...
<!-- END SOURCE: WorkingPractices_Design_v7.md -->
...
<!-- BEGIN SOURCE: AIDE_WorkingPractices_Standard_v6.md -->
...
<!-- END SOURCE: AIDE_WorkingPractices_Standard_v6.md -->
