...
> **Binder Version 2** (2026-08-31). Adds WIP continuity/currency and top-level-topic-aware live-state practice.

## Binder manifest

- `WorkingPractices_Index_v5.md` — sha256 `19edcc9dec57`
- `WorkingPractices_Brief_v4.md` — sha256 `fce514ebca7c`
- `WorkingPractices_Design_v5.md` — sha256 `704ea3911eaf`
- `WorkingPractices_Decisions_v5.md` — sha256 `ac5675177e5c`
- `AIDE_WorkingPractices_Standard_v4.md` — sha256 `44d190928e29`

---

<!-- BEGIN SOURCE: WorkingPractices_Index_v5.md -->
# Working Practices — Index

> **Version 5** (2026-08-31). Adopts Core Index and registers WIP/context-preservation practices.
>
...
|---|---:|---|---|
| `WorkingPractices_Index` | v5 | Index | Current |
| `WorkingPractices_Brief` | v4 | Brief | Current |
| `WorkingPractices_Design` | v5 | Design | Current |
| `WorkingPractices_Decisions` | v5 | Decisions | Current |
| `AIDE_WorkingPractices_Standard` | v4 | Standard | Current; identity `AIDE_WorkingPractices@v1` |

### Generated consumption artifact

Regenerate the current Working Practices Binder after these masters are applied. WIP/Working/
OpenItems/WorkRegister are not normal Binder sources under v21.
...
References: WorkingPractices_Design_v5, AIDE_WorkingPractices@v1
<!-- END SOURCE: WorkingPractices_Index_v5.md -->

---

<!-- BEGIN SOURCE: WorkingPractices_Brief_v4.md -->
...
<!-- END SOURCE: WorkingPractices_Brief_v4.md -->

---

<!-- BEGIN SOURCE: WorkingPractices_Design_v5.md -->
# Working Practices — Design

> **Version 5** (2026-08-31). Adds practical WIP persistence/currency behaviour and aligns
> workflow-state handling with the top-level-topic/container distinction while preserving the
> established Working Practices contract.
>
> Created: 2026-08-31 | Last modified: 2026-08-31
...
A **top-level topic** is the normal semantic anchor for standing workflow state. Therefore
OpenItems, WorkRegister and equivalent topic state are top-level-topic-wide by default, not
container-wide merely because the current UI or filesystem happens to group several topics.

Subtopic-specific state is created only where independent cadence, scale or retrieval need makes it
useful.
...
The normal Binder contains stable/current knowledge. Under Documentation Methodology v21, live
`WIP`, `Working`, `OpenItems` and `WorkRegister` are normally loaded separately. Reissuing a new
checkpoint in the same live-state series does not by itself force an Index or Binder regeneration.
...
Generated Binders remain stable/current consumption artefacts. `WIP`, `Working`, `OpenItems` and
`WorkRegister` are normally outside the Binder and loaded separately when live work state is
needed. A new checkpoint in an existing live-state series does not by itself require Binder
regeneration or force Index version churn; reconcile live-state series pointers at normal output
checkpoints.
...
---
Dependencies: !AIDE_DocumentationMethodology@v21
References: WorkingPractices_Decisions_v5, Principles_Design_v3, Core_Bootstrap_Design_v2
<!-- END SOURCE: WorkingPractices_Design_v5.md -->

---

<!-- BEGIN SOURCE: WorkingPractices_Decisions_v5.md -->
# Working Practices — Decisions

> **Version 5** (2026-08-31). Preserves the complete prior decision history and records WIP
> persistence/currency, top-level-topic workflow-state scope and the preservation-first checkpoint
> rule.
>
> Created: 2026-08-31 | Last modified: 2026-08-31
...
---
Dependencies: !AIDE_DocumentationMethodology@v21, WorkingPractices_Design_v5
References: DocumentationMethodology_Decisions_v19, Principles_Decisions_v3
<!-- END SOURCE: WorkingPractices_Decisions_v5.md -->
