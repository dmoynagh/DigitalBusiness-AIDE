...
> **Binder version 2** (2026-09-01). Assembles the Review B R1-remediated Project Design v3 current masters; live WorkRegister state remains separate.

## Binder manifest

- `ProjectDesign_Index_v3.md` — sha256 `485021784081`
- `ProjectDesign_Design_v3.md` — sha256 `b7f1821c7716`
- `ProjectDesign_Decisions_v3.md` — sha256 `0865db981e48`
- `AIDE_ProjectDesign_Standard_v3.md` — sha256 `011f81afdef9`

---

<!-- BEGIN SOURCE: ProjectDesign_Index_v3.md -->
...
<!-- END SOURCE: ProjectDesign_Index_v3.md -->

---

<!-- BEGIN SOURCE: ProjectDesign_Design_v3.md -->
# Project Design — Design

> **Version 3** (2026-09-01). Refines the WorkRegister ownership boundary from Review B: Project
> Design owns the mandatory Design-consequence producer/reconciliation rule; Documentation
> Methodology owns general WorkRegister type/admission semantics. Adds return-pending preservation.
>
> Created: 2026-08-30 | Last modified: 2026-09-01
...
```text
AIDE_ProjectDesign@v3
```

Migration posture is `None`: v3 refines ownership/admission wording and return-state preservation;
it does not require mass rewriting historical Design, WorkRegister, WorkPackage or Outcome records.
...
<!-- END SOURCE: ProjectDesign_Design_v3.md -->
...
<!-- BEGIN SOURCE: AIDE_ProjectDesign_Standard_v3.md -->
# AIDE Project Design — Standard

> **Identity:** `AIDE_ProjectDesign@v3`
> **Common name:** Project Design
> **Version 3** (2026-09-01). Review B refinement: Project Design owns the mandatory
> Design→WorkRegister producer/reconciliation rule while Documentation Methodology owns general
> WorkRegister type/admission semantics; adds return-pending preservation.
>
...
<!-- END SOURCE: AIDE_ProjectDesign_Standard_v3.md -->
