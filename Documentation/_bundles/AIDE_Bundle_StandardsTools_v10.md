...
> **Version 10** (2026-09-03). Refreshes the current Review D R2/closing baseline, including Build v9, Capability/Capability Build v4, Tags/Scope v3, Deployment v7, Registry Tool v2 and the current Capability Build tool family.
