...
> **Version 3** (2026-09-04). Corrects the log setting's name to `log_file`, matching the build and
> the version cleanup sibling. Moves descend-versus-process from Open into the processing model,
> where it is a satisfied constraint rather than outstanding work. No behaviour change from v2.
