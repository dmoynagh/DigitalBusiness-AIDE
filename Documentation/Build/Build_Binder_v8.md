...
> **Binder Version 8** (2026-09-02). Adds named Build Target handoff facts while preserving specialised producer ownership and the existing WorkPackage/post-Build contracts.

This Binder is a current-context consumption artefact; authoritative masters remain individual files.

## Binder manifest

- `Build_Index_v8.md` — sha256 `ceefbe923a28`
- `Build_Design_v8.md` — sha256 `99a3b052ccaa`
- `Build_Decisions_v8.md` — sha256 `dc18ffb28900`
...
<!-- BEGIN SOURCE: Build_Index_v8.md -->
# Build — Index
...
<!-- END SOURCE: Build_Index_v8.md -->

---

<!-- BEGIN SOURCE: Build_Design_v8.md -->
# Build — Design

> **Version 8** (2026-09-02). Adds named Build Target provenance to the generic deployment-facing output handoff.
>
> Created: 2026-08-30 | Last modified: 2026-09-02
...
The v8 transition posture is `None`: it strengthens future deployment-facing handoff evidence
...
---
Dependencies: !AIDE_DocumentationMethodology@v27, AIDE_WorkPackage@v3, AIDE_Review@v3
References: Build_WorkPackage_Design_v3, AIDE_StandardsProduction@v3, ProjectDesign_Design_v5, Build_PostBuild_Design_v2, AIDE_DeploymentRegistryTool@v1, AIDE_CapabilityBuild@v3
<!-- END SOURCE: Build_Design_v8.md -->

---

<!-- BEGIN SOURCE: Build_Decisions_v8.md -->
# Build — Decisions

> **Version 8** (2026-09-02). Records the generic Build boundary for named Build Targets and specialised Profiles.
>
> Created: 2026-08-30 | Last modified: 2026-09-02
...
---
Dependencies: !AIDE_DocumentationMethodology@v27, Build_Design_v8
References: ProjectDesign_Design_v2, AIDE_Deployment@v6, AIDE_DeploymentRegistryTool@v1, AIDE_WorkPackage@v3, AIDE_CapabilityBuild@v3
<!-- END SOURCE: Build_Decisions_v8.md -->
