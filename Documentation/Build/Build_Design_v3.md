> identity: Build_Design@v3 | doctype: design | updated: 2026-09-16
...
- **Standing policy in the profile** may require review for the applicable build channel.
...
- **Profile policy** — standing rules for the channel.
...
Version note: v3 — incorporates legacy-review carries (D24–D29), resolves three open questions (D30–D32). Adds: scalability as governing property, proactive feedback obligation, review activation model (dual-sourced, work-level-driven), build execution conventions, cross-cutting concern consumption. Resolves: profile storage, autonomy tiering default, build standard content deferral. Post-build dissolved into execution tail. 2026-09-16. Replaces v2.
