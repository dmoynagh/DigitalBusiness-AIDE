...
> **Version 3** (2026-08-31). Corrects Documentation Methodology Standard versioning so the
> canonical Standard filename aligns with the established `AIDE_DocumentationMethodology@v18` release.

This bundle contains canonical **Standards and Tools** only. It deliberately excludes internal
Design/Decisions/Index documents. Documentation Methodology is represented operationally by its
canonical v18 Standard; its v18 Guide remains the fuller human/explanatory companion in the
Documentation Methodology project Binder.
