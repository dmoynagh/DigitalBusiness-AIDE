...
> **Version 6** (2026-09-02). Post-reconciliation rebuild of the temporary common runtime bundle
> pending completion of the normal AIDE Build/AI Deployment route. It uses the current regenerated
> Core, Build, Capabilities, Documentation Methodology, Project Design and Working Practices
> Binders. The unchanged AI Deployment and Principles canonical sources are retained from Bundle v5.
