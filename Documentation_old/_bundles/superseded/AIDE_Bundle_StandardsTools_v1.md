...
> **Version 1** (2026-08-30). Common operational bundle for AIDE GPT Project contexts.

This bundle contains canonical **Standards and Tools** only. It deliberately excludes internal
Design/Decisions/Index documents. Documentation Methodology remains a Guide and is supplied by
its project Binder rather than being silently reclassified as a Standard.
