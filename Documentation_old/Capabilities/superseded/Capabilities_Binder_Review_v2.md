# Capabilities Review Binder

> **Generated Binder — do not edit directly.** Edit the individual master documents and regenerate the Binder.
> **Binder Version 2** (2026-08-31). Resolves the communication-owner seam to Messaging while preserving Review Profiles v1 and the established Review lifecycle.

This Binder is a project-context consumption artefact; authoritative masters remain individual files.

## Binder manifest

- `Capabilities_Review_Design_v2.md` — sha256 `abafac8ead5a`
- `Capabilities_Review_Decisions_v2.md` — sha256 `1c289449be70`
- `AIDE_Review_Standard_v2.md` — sha256 `9604655ef8d1`
- `AIDE_ReviewProfiles_Standard_v1.md` — sha256 `22ca6b64b427`
- `Capabilities_Review_Tool_Design_v2.md` — sha256 `8fc86742dc48`
- `AIDE_Review_Tool_v2.md` — sha256 `5a1df5dacb56`

---

<!-- BEGIN SOURCE: Capabilities_Review_Design_v2.md -->
# Capabilities Review — Design

> **Version 2** (2026-08-31). Resolves the previously open shared communication owner to
> AIDE Messaging while preserving the Review lifecycle, Type/Level/Mode/Reviewer model and
> environment route/settings seam.
>
> Created: 2026-08-29 | Last modified: 2026-08-31
...
- `AIDE_Review_Standard_v2` — current stable Review semantics and lifecycle;
- `AIDE_ReviewProfiles_Standard_v1` — the five reusable Review Types and their defaults;
- `Capabilities_Review_Tool_Design_v2` — the current specification for the Review orchestration Tool.
...
**Depends on:** `Capabilities_Review_Decisions_v2`, `Capabilities_Design_v9`,
`Capabilities_Decisions_v15`, `AIDE_Messaging@v1`.

**References:** `Capabilities_Overview_v14`, `Capabilities_Standards_Design_v4`,
`Capabilities_Tools_Design_v2`, `AIDE_Scope@v1`, `AIDE_Dependencies@v2`,
`AIDE_ReviewProfiles@v1`.

Dependencies: !AIDE_DocumentationMethodology@v21
<!-- END SOURCE: Capabilities_Review_Design_v2.md -->

---

<!-- BEGIN SOURCE: Capabilities_Review_Decisions_v2.md -->
# Capabilities Review — Decisions

> **Version 2** (2026-08-31). Resolves the previously open communication-owner seam to
> AIDE Messaging while preserving the established Review lifecycle and environment settings seam.
>
> Created: 2026-08-29 | Last modified: 2026-08-31
...
---
Dependencies: !AIDE_DocumentationMethodology@v21, Capabilities_Design_v9, Capabilities_Decisions_v15
References: Capabilities_Review_Design_v2, AIDE_Review@v2, AIDE_ReviewProfiles@v1,
Capabilities_Review_Tool_Design_v2, AIDE_Messaging@v1
<!-- END SOURCE: Capabilities_Review_Decisions_v2.md -->

---

<!-- BEGIN SOURCE: AIDE_Review_Standard_v2.md -->
# AIDE Review — Standard

> **Identity:** `AIDE_Review@v2`
> **Common name:** Review
> **Version 2** (2026-08-31). Resolves AI-MESSAGE communication ownership to `AIDE_Messaging@v1`
> while preserving the Review lifecycle, profiles and assurance semantics.
...
**Depends on:** `Capabilities_Review_Design_v2`, `AIDE_Messaging@v1`.

**References:** `AIDE_ReviewProfiles@v1`, `Capabilities_Design_v9`,
...
<!-- END SOURCE: AIDE_Review_Standard_v2.md -->
...
<!-- BEGIN SOURCE: Capabilities_Review_Tool_Design_v2.md -->
# Capabilities Review Tool — Design

> **Version 2** (2026-08-31). Resolves Review transport to AIDE Messaging for
> AI-MESSAGE relay/receipt semantics while leaving concrete route mechanics in environment/platform
> Build and preserving the existing Review orchestration contract.
>
> Created: 2026-08-29 | Last modified: 2026-08-31
...
1. Build the `ReviewResult` required by `AIDE_Review@v2`.
...
**Depends on:** `Capabilities_Review_Design_v2`, `AIDE_Review@v2`,
`AIDE_ReviewProfiles@v1`, `Capabilities_Tools_Design_v2`, `AIDE_Messaging@v1`.

**References:** `Capabilities_Design_v9`, `AIDE_Scope@v1`.

Dependencies: !AIDE_DocumentationMethodology@v21
<!-- END SOURCE: Capabilities_Review_Tool_Design_v2.md -->

---

<!-- BEGIN SOURCE: AIDE_Review_Tool_v2.md -->
# AIDE Review — Tool
...
Dependencies: !AIDE_DocumentationMethodology@v21, AIDE_Messaging@v1
<!-- END SOURCE: AIDE_Review_Tool_v2.md -->
