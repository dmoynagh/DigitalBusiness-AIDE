...
- `Capabilities_Index_v12.md` — sha256 `b067479e76c9`
- `Capabilities_Brief_v5.md` — sha256 `90a8c2ec2805`
- `Capabilities_Overview_v11.md` — sha256 `4f8680cd3348`
- `Capabilities_Design_v6.md` — sha256 `3645b4bf73de`
- `Capabilities_Decisions_v12.md` — sha256 `0ab01687dc2b`

---

<!-- BEGIN SOURCE: Capabilities_Index_v12.md -->
# Capabilities — Index
...
**Methodology:** v17
<!-- END SOURCE: Capabilities_Index_v12.md -->

---

<!-- BEGIN SOURCE: Capabilities_Brief_v5.md -->
# Capabilities — Brief

> **Version 5** (2026-08-29). Completes the Migration contract, reconciles Standards/Tools,
> separates release/package/deployment version concepts, and closes the producer-side
> Capability Package + Deployment Manifest contract while leaving Deployment behaviour open.
>
> Created: 2026-08-27 | Last modified: 2026-08-29
...
Canonical outcomes contain complete capability meaning plus only capability-specific platform
addenda. Generic skill/plugin/bundle/command implementation belongs Build side.
...
**References:** `Capabilities_Design` v6, `Capabilities_Migration_Design` v1,
`Capabilities_Standards_Design` v4, `Capabilities_Tools_Design` v2.

**Methodology:** v17
<!-- END SOURCE: Capabilities_Brief_v5.md -->

---

<!-- BEGIN SOURCE: Capabilities_Overview_v11.md -->
...
**Methodology:** v17
<!-- END SOURCE: Capabilities_Overview_v11.md -->

---

<!-- BEGIN SOURCE: Capabilities_Design_v6.md -->
# Capabilities — Design

> **Version 6** (2026-08-29). Completes Migration, reconciles Standards and Tools, finalises
> dependency processing precedence, separates version/package/deployment identities, and defines the
> minimal producer-side Package/Deployment Manifest contract. Deployment behaviour remains the next
...
behaviour. It publishes Production and Usage Standards.
...
Detailed contract: `Capabilities_Migration_Design` v1 / `AIDE_Migration@v1` and
`Capabilities_Migration_Tool_Design` v1.
...
Deployment starts only from a valid Package + Manifest and must not reopen Capability Design or
infer intent from payload structure.

A Deployment Set is a logical named collection/destination. Build is capability-local;
Deployment is set-aware and may compose contributions from multiple packages into one physical
platform artefact.

Already-owned responsibilities:
...
- resumption/idempotency requirements; and
- rejection of defective/contradictory inputs.

Still-open Deployment design includes set lifecycle/state, Deployment Config inheritance/ownership,
full vs incremental assembly, atomicity/partial failure/rollback/resume, and publication mechanics.

Physical platform mappings are intentionally not fixed here. In particular, the proposed OpenAI
plugin/skills path for ChatGPT + Codex must be proven with a representative Standard before it
becomes the primary Deployment mapping; bundle deployment remains possible where useful/fallback.
...
**Depends on:** `Capabilities_Brief` v5, `Capabilities_Decisions` v12.
...
`Capabilities_Review_Design` v1, `Core_System_Design` v3.

**Methodology:** v17
<!-- END SOURCE: Capabilities_Design_v6.md -->

---

<!-- BEGIN SOURCE: Capabilities_Decisions_v12.md -->
# Capabilities — Decisions

> **Version 12** (2026-08-29). **Migration / reconciliation checkpoint.** Finalises Migration,
> reconciles Standards and Tools, adds dependency processing precedence, resolves the shared
> version distinctions and minimal Package/Deployment Manifest producer contract, and leaves
> Deployment behaviour itself deliberately open. Earlier decisions remain as design history and
> are superseded where stated below.
>
> Created: 2026-08-27 | Last modified: 2026-08-29
...
**Depends on:** `Workflow-D106`–`Workflow-D113` (referenced, not duplicated),
`Capabilities_Review_Decisions` v1.

**References:** `Core_System_Design` v3, `Capabilities_Design` v6,
`Capabilities_Standards_Design` v4, `Capabilities_Tools_Design` v2,
`Capabilities_Brief` v5, `Capabilities_DocMethReviewItems` v3,
`Capabilities_Dependencies_Design` v2, `Capabilities_Migration_Design` v1,
`Capabilities_Review_Design` v1, `AIDE_Review@v1`, `AIDE_ReviewProfiles@v1`,
`Capabilities_Review_Tool_Design` v1.

**Methodology:** v17
<!-- END SOURCE: Capabilities_Decisions_v12.md -->
