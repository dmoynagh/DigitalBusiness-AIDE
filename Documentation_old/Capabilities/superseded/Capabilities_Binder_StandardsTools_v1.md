...
> **Binder Version 1** (2026-09-01). First versioned Standards/Tools Binder issue; applies Review C R1 reference-production remediation and publishes AIDE_ToolsProduction@v1.

This Binder is a project-context consumption artefact; authoritative masters remain individual files.

## Binder manifest

- `Capabilities_Standards_Brief_v2.md` — sha256 `37ff62ee26b0`
- `Capabilities_Standards_Design_v5.md` — sha256 `5da9b8d225c8`
- `AIDE_StandardsProduction_Standard_v2.md` — sha256 `c85124b6ef1a`
- `AIDE_StandardsUsage_Standard_v1.md` — sha256 `aa3b4c36a00b`
- `Capabilities_Tools_Brief_v3.md` — sha256 `59e3028e188a`
- `Capabilities_Tools_Design_v3.md` — sha256 `037ec3629109`
- `AIDE_ToolsProduction_Standard_v1.md` — sha256 `971dc565a282`
- `Capabilities_BuildCapability_Tool_Design_v2.md` — sha256 `8e2dfc0bcd61`
- `AIDE_BuildCapability_Tool_v2.md` — sha256 `1f5ab96b32e5`
...
<!-- BEGIN SOURCE: Capabilities_Standards_Design_v5.md -->
# Capabilities Standards — Design

> **Version 5** (2026-09-01). Adds Review C production-time capability-reference validation while preserving the existing Standard kind, weights and ownership boundaries.
...
References: Capabilities_Standards_Brief_v2, Capabilities_Tools_Design_v3, AIDE_Scope@v2, AIDE_Dependencies@v3, AIDE_Migration@v2, AIDE_Review
<!-- END SOURCE: Capabilities_Standards_Design_v5.md -->
