...
> **Binder Version 3** (2026-09-02). Adds required Definitions, Element-release production, Update Capability Elements, Build Capability v3 and Capability Builder.

This Binder is a current-context consumption artefact; authoritative masters remain individual files.

## Binder manifest

- `Capabilities_Standards_Definition_v1.md` — sha256 `079cf63fe677`
...
- `Capabilities_Tools_Definition_v1.md` — sha256 `14d6f37bade0`
- `Capabilities_Tools_Brief_v4.md` — sha256 `0c2a2b493f6e`
- `Capabilities_Tools_Design_v4.md` — sha256 `5b9d06f5b35d`
...
- `Capabilities_BuildCapability_Tool_Design_v3.md` — sha256 `5c1ddfb80c64`
- `AIDE_BuildCapability_Tool_v3.md` — sha256 `89fa109cea7a`
- `Capabilities_CapabilityBuilder_Tool_Design_v1.md` — sha256 `464b92482a3e`
- `AIDE_CapabilityBuilder_Tool_v1.md` — sha256 `9400a2d3c9cf`

---

<!-- BEGIN SOURCE: Capabilities_Standards_Definition_v1.md -->
...
References: Capabilities_Standards_Design_v7, AIDE_StandardsProduction@v3, AIDE_StandardsUsage@v2
<!-- END SOURCE: Capabilities_Standards_Definition_v1.md -->
...
<!-- BEGIN SOURCE: Capabilities_Tools_Definition_v1.md -->
...
| `Tools.BuildCapability` | Tool | `AIDE_BuildCapabilityTool@v3` | v1 |
| `Tools.CapabilityBuilder` | Tool | `AIDE_CapabilityBuilderTool@v1` | v1 |
...
| `Tools.BuildCapability` | Current sources/contracts identified by Definition references | 2026-09-02 baseline |
| `Tools.CapabilityBuilder` | Current sources/contracts identified by Definition references | 2026-09-02 baseline |
...
---
Dependencies: !AIDE_DocumentationMethodology@v27, AIDE_Capability@v1, AIDE_Dependencies@v3, AIDE_Migration@v2
References: Capabilities_Tools_Design_v4, AIDE_ToolsProduction@v2
<!-- END SOURCE: Capabilities_Tools_Definition_v1.md -->

---

<!-- BEGIN SOURCE: Capabilities_Tools_Brief_v4.md -->
# Capabilities Tools — Brief

> **Version 4** (2026-09-02). Adds the Tools Capability Definition and separates the three current production/build Tools.
...
Element update, Build request orchestration and Build-side execution are separate current Tools under `Capabilities_Tools_Definition_v1`.

---
Dependencies: !AIDE_DocumentationMethodology@v27, Capabilities_Design_v12, Capabilities_Tools_Design_v4
References: Capabilities_Brief_v11, AIDE_Scope@v2, AIDE_Dependencies@v3, AIDE_Migration@v2
<!-- END SOURCE: Capabilities_Tools_Brief_v4.md -->

---

<!-- BEGIN SOURCE: Capabilities_Tools_Design_v4.md -->
...
<!-- END SOURCE: Capabilities_Tools_Design_v4.md -->
...
<!-- BEGIN SOURCE: Capabilities_BuildCapability_Tool_Design_v3.md -->
...
<!-- END SOURCE: Capabilities_BuildCapability_Tool_Design_v3.md -->

---

<!-- BEGIN SOURCE: AIDE_BuildCapability_Tool_v3.md -->
...
<!-- END SOURCE: AIDE_BuildCapability_Tool_v3.md -->

---

<!-- BEGIN SOURCE: Capabilities_CapabilityBuilder_Tool_Design_v1.md -->
...
<!-- END SOURCE: Capabilities_CapabilityBuilder_Tool_Design_v1.md -->

---

<!-- BEGIN SOURCE: AIDE_CapabilityBuilder_Tool_v1.md -->
...
<!-- END SOURCE: AIDE_CapabilityBuilder_Tool_v1.md -->
