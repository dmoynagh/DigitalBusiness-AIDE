...
> **Version 9** (2026-08-28). **Capability production and deployment refinement.** Preserves
> the seven-component architecture while moving generic platform adaptation to Build side,
> establishing canonical capability outcomes, Build Config and Deployment Sets, embedding
> transition declarations in Standards/Tools, and moving WorkPackage ownership to AIDE Build.
> Earlier decisions remain as design history and are marked where revised or superseded.
>
...
`Capabilities_Tools_Design` v1 (revision required), `Capabilities_Brief` v3,
