...
> **Binder Version 3** (2026-09-01). Applies Review C R1 cross-layer correlation integrity and versionless Review Profile references while preserving the established Review lifecycle.

This Binder is a project-context consumption artefact; authoritative masters remain individual files.

## Binder manifest

- `Capabilities_Review_Design_v3.md` — sha256 `60ee1f8233ec`
- `Capabilities_Review_Decisions_v3.md` — sha256 `01cff0db6a15`
- `AIDE_Review_Standard_v3.md` — sha256 `76ddefe7a36a`
- `AIDE_ReviewProfiles_Standard_v2.md` — sha256 `21c84465ca3d`
- `Capabilities_Review_Tool_Design_v3.md` — sha256 `d77d70ad50c8`
- `AIDE_Review_Tool_v3.md` — sha256 `027adf81213e`

---

<!-- BEGIN SOURCE: Capabilities_Review_Design_v3.md -->
# Capabilities Review — Design

> **Version 3** (2026-09-01). Adds authoritative Review/Round versus transport-correlation mismatch handling and advances current Review/Profile/Tool outcomes after Review C R1.
...
- `AIDE_Review_Standard_v3` — current stable Review semantics and lifecycle;
...
---
Dependencies: !AIDE_DocumentationMethodology@v26, Capabilities_Review_Decisions_v3, Capabilities_Design_v10, Capabilities_Decisions_v16, AIDE_Messaging@v2
References: Capabilities_Overview_v15, Capabilities_Standards_Design_v5, Capabilities_Tools_Design_v3, AIDE_Scope@v2, AIDE_Dependencies@v3, AIDE_ReviewProfiles@v2
<!-- END SOURCE: Capabilities_Review_Design_v3.md -->

---

<!-- BEGIN SOURCE: Capabilities_Review_Decisions_v3.md -->
...
<!-- END SOURCE: Capabilities_Review_Decisions_v3.md -->
