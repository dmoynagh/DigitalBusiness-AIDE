# Capabilities Binder Core

> **Generated Binder — do not edit directly.** Edit the individual master documents and regenerate the Binder.
> **Binder Version 11** (2026-09-03). Review D R2 closing correction: Capability v4 current pointer, Review D closure and Review E programme state.

This Binder is a current-context consumption artefact; authoritative masters remain individual files.

## Binder manifest

- `Capabilities_Index_v25.md` — sha256 `1b7a353ae922`
- `Capabilities_Brief_v14.md` — sha256 `7f2d8f18d08b`
- `Capabilities_Overview_v20.md` — sha256 `8f78e2ba0a61`
- `Capabilities_Design_v15.md` — sha256 `8f9d54dca3b9`
- `Capabilities_Decisions_v21.md` — sha256 `ccfb98c6b33b`
- `Capabilities_Capability_Design_v3.md` — sha256 `df8a48ebb4b9`
- `Capabilities_Capability_Decisions_v2.md` — sha256 `a4b1ec2afa8d`
- `AIDE_Capability_Standard_v4.md` — sha256 `ba7ed3521171`
- `Capabilities_BuildTargetProfile_Design_v2.md` — sha256 `054dd28909f0`
- `Capabilities_AIDECore_BuildTargetProfile_v2.md` — sha256 `442030bcc424`
- `Capabilities_CapabilityBuild_Design_v4.md` — sha256 `20c62e3f5b49`
- `Capabilities_CapabilityBuild_Decisions_v4.md` — sha256 `58173604406a`
- `AIDE_CapabilityBuild_Standard_v4.md` — sha256 `6fef472dd038`

---

<!-- BEGIN SOURCE: Capabilities_Index_v25.md -->
# Capabilities — Index

> **Version 25** (2026-09-03). Registers the Review D R2 closing correction, Review D completion at High and transition to Review E.
...
| Tools | `Capabilities_Tools_Definition_v6` | `AIDE_ToolsProduction@v3`, `AIDE_UpdateCapabilityElementsTool@v1`, `AIDE_BuildCapabilityTool@v6`, `AIDE_CapabilityBuilderTool@v4` |
...
|---|---:|---|---|
| `Capabilities_Index` | v25 | Index | Current |
...
| `AIDE_Capability_Standard` | v4 | Standard | `AIDE_Capability@v4` |
...
| Binder | Boundary |
|---|---|
| `Capabilities_Binder_Core_v11` | parent architecture + Capability/Capability Build/Profile contracts |
| `Capabilities_Binder_StandardsTools_v8` | Standards/Tools Definitions, production contracts and current Capability production/build Tools |
...
`Capabilities_Binder_Set_Index_v6` is the lightweight generated map. The partitions collectively
...
Reviews A–D are complete at High. Review D closed after R1 Robust remediation survived R2
Inspect/High/Full and its three Minor current-reference residuals were corrected without another
Round. The peer architecture programme now advances to Review E — integrated coherence.

---
Dependencies: !AIDE_DocumentationMethodology@v28, AIDE_Capability@v4, AIDE_CapabilityBuild@v4
References: Capabilities_WIP_v21, Capabilities_WorkRegister_v21, Capabilities_OpenItems_v17, Capabilities_Architecture_Review_2026-09-03-4_DesignToProduction_v1
<!-- END SOURCE: Capabilities_Index_v25.md -->

---

<!-- BEGIN SOURCE: Capabilities_Brief_v14.md -->
# Capabilities — Brief
...
<!-- END SOURCE: Capabilities_Brief_v14.md -->

---

<!-- BEGIN SOURCE: Capabilities_Overview_v20.md -->
...
<!-- END SOURCE: Capabilities_Overview_v20.md -->

---

<!-- BEGIN SOURCE: Capabilities_Design_v15.md -->
# Capabilities — Design
...
<!-- END SOURCE: Capabilities_Design_v15.md -->

---

<!-- BEGIN SOURCE: Capabilities_Decisions_v21.md -->
# Capabilities — Decisions

> **Version 21** (2026-09-03). Records Review D R1 production-seam remediation.
...
**Status: revised by D139.** The historical Definition model below included post-Build intent; current semantics keep post-Build request/intent in WorkPackage/workflow state rather than the Capability Definition.
...
**Status: superseded in part by D139.** Package immutability remains; the historical allowance for package-carried post-Build request/intent is removed by D139.
...
**Status: historical v1 release point; revised by D139–D140.** Current Registry publication follows the current AI Deployment Registry Tool contract; coordinated producer changes use the common Open Release Batch rule in D140.
...
## D122 — Build Target is producer output; Deployment Target is runtime realisation

**Decision.** A Build Target Definition states what one deployment-facing Capability Build output
must contain. A Deployment Target states where/how a final Deployment Output is published,
installed, attached or used. One built/output representation may feed several Deployment Targets.

**Reason.** Claude account and Claude Code may consume one plugin output while retaining independent
installation/runtime state. Multiplying Build Targets by install surface would conflate content
production with environment reconciliation.

## D123 — Reusable Build Target Profiles own common target requirements

**Decision.** A Build Target Profile groups compatible Build Target Definitions and may own explicit
Capability membership. Capability Definitions/requests contribute selection or delta-only
Capability-specific overrides where needed. Exactly one effective Definition set resolves before
Build.

**Reason.** Shared representation requirements should be defined once without copying four target
blocks into every Capability Definition.

## D124 — Applicability, conformance and degradation are explicit producer facts

**Decision.** Every selected Profile target resolves applicability, support, full conformance and any
permitted degradation/variation. `NotApplicable` requires a producer-owned reason. An applicable
required target without a valid output blocks the Package. Permitted degradation remains visible to
downstream verification.

**Reason.** Missing output, deliberate irrelevance and supported-but-reduced behaviour have
different operational consequences and must not collapse into one optional field.

## D125 — AIDE Core uses four MemberContribution Build Targets

**Decision.** `AIDE_Core` initially selects Standards, Tools, Tags, Scope, Dependencies, Migration,
Review and Messaging and requires `ClaudePlugin`, `ClaudeBundle`, `ChatGPTBundle` and `OpenAIPlugin`
contributions for every applicable member Capability. Outputs carry the `AIDE_Core` Tag.

**Reason.** These are the four confirmed reusable representations from which AI Deployment can
assemble the shared AIDE Core release across Claude, ChatGPT and Codex surfaces.

## D126 — AIDE Core Profile contains no delivery mechanics

**Decision.** The Profile specifies output representation/reach/conformance requirements but not
marketplace repositories, paths, accounts, install/update commands, pickup rules or target state.

**Reason.** Those facts are environment/AI Deployment configuration and may change without
rebuilding capability semantics or revising the Profile.

## D127 — Profile revisions and Capability releases remain distinct

**Decision.** A Profile revision may require a new PackageId/build for an unchanged Capability
release. Capability release advances only for substantive Capability-level Definition/composition
change; target rebuild provenance remains package state.

**Reason.** A downstream exact Set must detect changed concrete target outputs without falsely
claiming semantic Capability change.

## D128 — Review D may restart after coordinated application

**Decision.** The earlier Review D hold condition is satisfied by the confirmed Build Target/Profile
and AI Deployment Set/output/delivery design. Keep Review D on hold until this coordinated change
package is applied and its baseline refreshed; then restart it as a fresh design-to-production
review rather than resuming stale Round findings.

## D129 — Do not create a synthetic universal document dependency

**Decision.** Do not introduce `AIDE_Doc@v#` solely as a common migration hook. Governed documents
already declare the genuine `AIDE_DocumentationMethodology` conformance dependency; use that
dependency and other real capability dependencies for migration/update selection.

**Reason.** A synthetic identity would create false semantic coupling and a second document-version
axis without adding genuine capability meaning.

## D130 — AIDE Update Tool owns aggregate orchestration

**Decision.** Introduce `AIDE_UpdateTool@v1` above per-artefact Migration. It can target a Domain,
multiple Domains, the current session Domains, a Documentation Topic, explicit artefacts or a
criteria-selected set. It owns aggregate target resolution, authoritative-corpus selection,
orchestration and reporting.

**Boundary.** `AIDE_Migration`/`AIDE_MigrationTool` continue to own each artefact's transition
resolution, ordering, success/failure/defer state, durable partial progress and dependency-checkpoint
advancement.

## D131 — Domain-wide Required Migration and Update are distinct

**Decision.** Aggregate Required Migration selects only authoritative artefacts with outstanding
applicable Required work; it does not sweep artefacts solely for OnUpdate work. Aggregate Update is
an explicit qualifying update for every selected authoritative artefact and reconciles applicable
Required and OnUpdate work through current under normal per-artefact rules.

**Clarification.** When selected Required work causes an artefact save, the existing per-artefact
rule may also apply its pending OnUpdate work through current. This does not make OnUpdate-only
artefacts part of the Required-Migration selection.

## D132 — Aggregate selection does not transfer authority

**Decision.** Mutate only artefacts authoritative within the selected target and current work
authority. Consuming/external-owner artefacts reached through dependencies/search are report-only
unless independently selected through an authoritative target with authority. Selecting multiple
Domains does not create Domain inheritance or merge semantics.

## D133 — Standard and Tool DocTypes consume value-based orientation

**Decision.** Standard and Tool production use Documentation Methodology Contents/Summary only where
they add dual-audience comprehension/navigation value. A substantial Standard Summary states its
high-level operating model, principal rules and boundaries. A substantial Tool Summary states its
outcome, overall flow, main decision/effect points and constraints. Small/self-evident outcomes may
omit them.

## D134 — Durable Review uses its Result as the Summary surface

**Decision.** A substantial durable Review document exposes semantic Contents where navigation adds
value and places the concise Review Result at the top as its Summary-equivalent surface. Detailed
Round/Finding/evidence history remains authoritative below. A separate duplicative Summary is not
required when Review Result already performs that role.

## D135 — Release affected Capability Elements with posture None

**Decision.** Release `AIDE_Migration@v3`, `AIDE_MigrationTool@v3`, `AIDE_UpdateTool@v1`,
`AIDE_StandardsProduction@v4`, `AIDE_ToolsProduction@v3` and `AIDE_Review@v4`. All new transitions
use posture `None`: the new structure applies prospectively/on normal update and does not demand a
mass rewrite of unchanged current artefacts.

## D136 — Element Production checkpoints are exact and mutable

**Decision.** Every current Capability Definition records each applicable production input by stable
identity plus exact version/revision or digest, with evaluation date/status. A prose reference to
“current sources” plus a date is insufficient. Advancing this checkpoint after unchanged
reassessment does not create a semantic Element or Capability release.

## D137 — Capability Build maps into WorkPackage v3

**Decision.** Keep generic `AIDE_WorkPackage@v3`. Capability Build maps Definition/Elements,
selected platforms, exact source snapshot and Profile/Definitions into Inputs; targets/Package into
RequiredOutputs; conformance/Tags/force/post-Build request into Constraints; package validation into
Acceptance; and Package plus separate post-Build evidence into Return.

## D138 — Generated Tags freeze relative to the Build snapshot

**Decision.** Run or validate applicable Tag Builders against the exact authoritative Build source
snapshot before Capability Package freeze and preserve compact evidence. Registry, Deployment,
Machine Scope and runtime consumers use the frozen snapshot-relative Tags; they do not regenerate
producer-owned Tags from later source state.

## D139 — Post-Build request is not immutable package content

**Decision.** Remove nominated post-Build request/intent from Capability Definition/package
semantics. Carry it in Build request/WorkPackage workflow authority, execute after validation and
return the actual result separately in Outcome/Registry state.

## D140 — Coordinated producer changes require one Open Release Batch

**Decision.** An independent package may register directly. Once several packages form one
coordinated producer change, every participating registration uses the same Open Release Batch.
Batch use is not optional after coordination is established.

## D141 — RequiredReach is producer intent, not Target-state assurance

**Decision.** RequiredReach states required/intended representation support for a recognised reach
under applicable platform/environment conditions. It does not assert that every concrete Target is
configured, authorised, installed or runtime-active. Repeated/authoritative contradictory
Deployment evidence returns for Profile/Working Surface reassessment without a new generic feedback
mechanism.

## D142 — Review D R1 advances to targeted Inspect verification

**Decision.** Record restarted Review D R1 as complete and Lead-dispositioned. Apply the accepted
bounded seam corrections as one coordinated pass, keep Reviews A–C closed, and verify the remediated
baseline through Inspect/High/Full R2 rather than another pre-remediation Robust round.

---
Dependencies: !AIDE_DocumentationMethodology@v28, Capabilities_Design_v15
References: Capabilities_Messaging_Design_v3, Capabilities_Review_Design_v4, Capabilities_Migration_Design_v3, Capabilities_Update_Tool_Design_v1, Capabilities_Standards_Design_v8, Capabilities_Tools_Design_v7, AIDE_Deployment@v7, AIDE_DeploymentRegistryTool@v2
<!-- END SOURCE: Capabilities_Decisions_v21.md -->

---

<!-- BEGIN SOURCE: Capabilities_Capability_Design_v3.md -->
...
<!-- END SOURCE: Capabilities_Capability_Design_v3.md -->

---

<!-- BEGIN SOURCE: Capabilities_Capability_Decisions_v2.md -->
...
<!-- END SOURCE: Capabilities_Capability_Decisions_v2.md -->

---

<!-- BEGIN SOURCE: AIDE_Capability_Standard_v4.md -->
# AIDE Capability — Standard

> **Identity:** `AIDE_Capability@v4`
> **Common name:** Capability
> **Version 4** (2026-09-03). Review D R2 closing correction: points the current Build Target/Profile instruction at the current v2 contract; no semantic model change.
...
2. The Definition identifies Capability identity/release, purpose/boundary, Elements/composition,
   ...
   History and Build Target Profile/override facts as applicable.
...
7. Element Production separates immutable release-source snapshots from mutable evaluated-input
   checkpoints. Each checkpoint identifies every applicable input by exact version/revision or
   digest plus the evaluation date/status; generic prose such as “current references” is not an
...
13. Post-Build action/request is workflow authority carried by the Build request/WorkPackage and
    Outcome. It is not Capability Definition semantics and is not frozen into immutable Package bytes.
...
Use `Capabilities_BuildTargetProfile_Design_v2` for deployment-facing Build Target/Profile
...
References: Capabilities_Capability_Design_v3, Capabilities_BuildTargetProfile_Design_v2
<!-- END SOURCE: AIDE_Capability_Standard_v4.md -->

---

<!-- BEGIN SOURCE: Capabilities_BuildTargetProfile_Design_v2.md -->
...
<!-- END SOURCE: Capabilities_BuildTargetProfile_Design_v2.md -->

---

<!-- BEGIN SOURCE: Capabilities_AIDECore_BuildTargetProfile_v2.md -->
...
<!-- END SOURCE: Capabilities_AIDECore_BuildTargetProfile_v2.md -->

---

<!-- BEGIN SOURCE: Capabilities_CapabilityBuild_Design_v4.md -->
...
<!-- END SOURCE: Capabilities_CapabilityBuild_Design_v4.md -->

---

<!-- BEGIN SOURCE: Capabilities_CapabilityBuild_Decisions_v4.md -->
...
<!-- END SOURCE: Capabilities_CapabilityBuild_Decisions_v4.md -->

---

<!-- BEGIN SOURCE: AIDE_CapabilityBuild_Standard_v4.md -->
...
<!-- END SOURCE: AIDE_CapabilityBuild_Standard_v4.md -->
