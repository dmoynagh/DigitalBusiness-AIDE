...
> **Binder Version 6** (2026-09-01). Review B R1 pre-Round-2 preflight correction: assembles the
> v25 current masters reflecting the coordinated `AIDE_WorkPackage@v3` split-obligation seam only;
> no Review C / dependency-checkpoint policy is introduced.
...
<!-- BEGIN SOURCE: DocumentationMethodology_Index_v10.md -->
...
<!-- END SOURCE: DocumentationMethodology_Index_v10.md -->

---

<!-- BEGIN SOURCE: DocumentationMethodology_Design_v22.md -->
...
<!-- END SOURCE: DocumentationMethodology_Design_v22.md -->

---

<!-- BEGIN SOURCE: DocumentationMethodology_Decisions_v23.md -->
# Documentation Methodology — Decisions

> **Version 23** (2026-09-01). Review B R1 pre-Round-2 preflight correction: preserves prior
> history and corrects the current D39 coordinated-remediation consequence to `AIDE_WorkPackage@v3`.
> No new substantive Design decision is introduced.
>
> Created: 2026-08-30 | Last modified: 2026-09-01
...
---
Dependencies: !AIDE_DocumentationMethodology@v25, AIDE_Index@v2, DocumentationMethodology_Design_v22
References: DocumentationMethodology_Guide_v25, Core_Index_Decisions_v1, WorkingPractices_Decisions_v5, AIDE_WorkPackage@v2
<!-- END SOURCE: DocumentationMethodology_Decisions_v23.md -->

---

<!-- BEGIN SOURCE: AIDE_DocumentationMethodology_Standard_v25.md -->
...
<!-- END SOURCE: AIDE_DocumentationMethodology_Standard_v25.md -->

---

<!-- BEGIN SOURCE: DocumentationMethodology_Guide_v25.md -->
# Documentation & Workflow Methodology — Guide

> **Identity:** `AIDE_DocumentationMethodology@v25`
> **Version 25** (2026-09-01). Review B R1 pre-Round-2 preflight correction: aligns the current
> split-obligation WorkPackage seam with `AIDE_WorkPackage@v3` while preserving the v24 model.
>
> **Migration posture:** None for v25. This coordinated-reference correction requires no consumer
...
v25 has posture `None`.

Do not mass-rewrite current documents because of this pre-Round-2 correction or the v24 work-state clarifications.
Existing current WIP/Working/OpenItems/WorkRegister artefacts adopt the v24/v25 rules on their next
...
The pre-Round-2 correction updates only the Review B R1 current WorkPackage seam affected by the
coordinated Build/WorkPackage remediation: the D39 consequence and the Standard's current executable
WorkPackage integration reference now reflect `AIDE_WorkPackage@v3`. Historical Decision references
remain history, and footer `Dependencies:` / `References:` are not swept merely for version currency.
No general in-body capability-version or dependency-checkpoint policy is established here; that
remains outside Review B R1.
...
References: DocumentationMethodology_Design_v22, AIDE_DocumentationMethodology@v25, WorkingPractices_Design_v5, AIDE_WorkingPractices
<!-- END SOURCE: DocumentationMethodology_Guide_v25.md -->
