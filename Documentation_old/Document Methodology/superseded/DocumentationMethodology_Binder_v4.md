...
> **Binder Version 4** (2026-09-01). Review A R2 preflight correction: assembles the v23 current
> masters consuming/conforming to Core `AIDE_Index@v2`; no Review B semantics included.

## Binder manifest

- `DocumentationMethodology_Index_v8.md` — sha256 `6f7a9cb3cfbf`
- `DocumentationMethodology_Design_v20.md` — sha256 `9a207f58fedc`
- `DocumentationMethodology_Decisions_v21.md` — sha256 `3d99dbe4c9bf`
- `AIDE_DocumentationMethodology_Standard_v23.md` — sha256 `785bcb3e3315`
- `DocumentationMethodology_Guide_v23.md` — sha256 `703d5452b710`

---

<!-- BEGIN SOURCE: DocumentationMethodology_Index_v8.md -->
...
<!-- END SOURCE: DocumentationMethodology_Index_v8.md -->

---

<!-- BEGIN SOURCE: DocumentationMethodology_Design_v20.md -->
...
<!-- END SOURCE: DocumentationMethodology_Design_v20.md -->

---

<!-- BEGIN SOURCE: DocumentationMethodology_Decisions_v21.md -->
# Documentation Methodology — Decisions

> **Version 21** (2026-09-01). Mechanical Review A R2 preflight checkpoint only: preserves the
> complete substantive decision history unchanged while advancing current dependency metadata to
> `AIDE_Index@v2` / `AIDE_DocumentationMethodology@v23`. No new Decisions event.
>
> Created: 2026-08-30 | Last modified: 2026-09-01
...
---
Dependencies: !AIDE_DocumentationMethodology@v23, AIDE_Index@v2, DocumentationMethodology_Design_v20
References: DocumentationMethodology_Guide_v23, Core_Index_Decisions_v1, WorkingPractices_Decisions_v5, AIDE_WorkPackage@v2
<!-- END SOURCE: DocumentationMethodology_Decisions_v21.md -->

---

<!-- BEGIN SOURCE: AIDE_DocumentationMethodology_Standard_v23.md -->
...
> > **Change:** Review A R2 preflight correction — current generic Index consumption/conformance advanced to `AIDE_Index@v2`.
>
...
`DocumentationMethodology_Guide_v23` is its fuller human-oriented companion.
...
```text
Dependencies: !AIDE_DocumentationMethodology@v23
```
...
v22 and v23 require no additional artefact transformation; when Migration traverses through current during
...
rewrites; the corrected root-WIP convention applies prospectively to current/new checkpoints. v23
requires no consumer content transformation; it corrects current conformance to `AIDE_Index@v2`.
...
References: DocumentationMethodology_Design_v20, DocumentationMethodology_Guide_v23
<!-- END SOURCE: AIDE_DocumentationMethodology_Standard_v23.md -->

---

<!-- BEGIN SOURCE: DocumentationMethodology_Guide_v23.md -->
...
<!-- END SOURCE: DocumentationMethodology_Guide_v23.md -->
