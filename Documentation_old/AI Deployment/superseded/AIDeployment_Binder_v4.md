...
> **Version 4** (2026-08-31). Rebuilt after adoption of the Build v3 deployment-facing output contract and explicit composition posture.

## Binder manifest

- `AIDeployment_Index_v4.md` — sha256 `b5c514f8be94`
- `AIDeployment_Design_v4.md` — sha256 `f99200cb60de`
- `AIDeployment_Decisions_v4.md` — sha256 `be4f6f51ab11`
...
<!-- BEGIN SOURCE: AIDeployment_Index_v4.md -->
# AI Deployment — Index
...
<!-- END SOURCE: AIDeployment_Index_v4.md -->

---

<!-- BEGIN SOURCE: AIDeployment_Design_v4.md -->
# AI Deployment — Design

> **Version 4** (2026-08-31). Consumes the Build v3 output contract explicitly, including
> `MemberContribution` / `AssembledConsumptionArtefact` composition posture.
>
> Created: 2026-08-30 | Last modified: 2026-08-31
...
- Deployment consumes current built outputs, their Build-declared composition posture and declared package/manifest intent; it does not reopen the producer's Design or perform a second semantic Build.
...
Build owns semantic rendering/transformation from current authoritative/canonical sources into concrete Build outputs. The Build output contract supplies authoritative/canonical source identity/version provenance, concrete Build-output/package identity and integrity evidence, and a Build-owned `CompositionPosture` of `MemberContribution` or `AssembledConsumptionArtefact`.
...
Build output(s)
      ...
      + source provenance + Build-output/package identity/integrity
      ↓
AI Deployment
      ↓
...
---
Dependencies: !AIDE_DocumentationMethodology@v18, Capabilities_Design_v8, Build_Design_v3
References: AIDE_WorkPackage@v1, AIDE_Build@v3, AIDE_Dependencies@v2, AIDeployment_OpenAI_Reference_v2
<!-- END SOURCE: AIDeployment_Design_v4.md -->

---

<!-- BEGIN SOURCE: AIDeployment_Decisions_v4.md -->
# AI Deployment — Decisions

> **Version 4** (2026-08-31). Records adoption of the Build v3 deployment-facing output
> composition-posture contract.
>
> Created: 2026-08-30 | Last modified: 2026-08-31
...
---
Dependencies: !AIDE_DocumentationMethodology@v18, AIDeployment_Design_v4
References: Capabilities_Design_v8, Core_System_Design_v4, Build_Design_v3, AIDE_Build@v3, AIDE_Dependencies@v2, AIDeployment_OpenAI_Reference_v2
<!-- END SOURCE: AIDeployment_Decisions_v4.md -->
