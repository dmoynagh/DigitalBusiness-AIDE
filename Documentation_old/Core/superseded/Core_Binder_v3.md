...
> **Binder Version 3** (2026-09-01). Final Review A Round 2 correction checkpoint: applies inclusive Propagation Stop semantics and deterministic unique-host eligibility for implicit Domain settings while retaining the unchanged current Index and Bootstrap contracts.

This Binder is a project-context consumption artefact; authoritative masters remain individual files.

## Binder manifest

- `Core_Index_v6.md` — sha256 `36bf77711d3f`
- `Core_System_Design_v9.md` — sha256 `9a54c0ce13fa`
...
<!-- BEGIN SOURCE: Core_Index_v6.md -->
# Core — Index

> **Version 6** (2026-09-01). Registers the final Review A Round 2 Domain determinism corrections:
> `AIDE_Domain@v4`, `Core_Domain_Design_v4`, `Core_Domain_Decisions_v4` and the coordinated
> `Core_System_Design_v9`, while retaining unchanged Index and Bootstrap contracts.
>
...
References: Core_System_Design_v9, Core_Index_Design_v2, Core_Domain_Design_v4, Core_Bootstrap_Design_v3
<!-- END SOURCE: Core_Index_v6.md -->

---

<!-- BEGIN SOURCE: Core_System_Design_v9.md -->
# Core System — Design

> **Version 9** (2026-09-01). Applies the final Review A Round 2 Domain determinism corrections:
> Propagation Stop includes the marked boundary and its contained region, implicit Domain settings
> require one unambiguous eligible authoritative host, and the canonical Domain outcome is v4.
>
...
---
Dependencies: !AIDE_DocumentationMethodology@v23, AIDE_Index@v2
References: Core_Index_Design_v2, Core_Domain_Design_v4, Core_Bootstrap_Design_v3, Principles_Design_v3, WorkingPractices_Design_v5, ProjectDesign_Design_v2, Build_Design_v4
<!-- END SOURCE: Core_System_Design_v9.md -->
