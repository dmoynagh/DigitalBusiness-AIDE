...
> **Binder Version 5** (2026-09-02). Adds capability-led Working Context, genuine-transfer Handoff, completion reconciliation and transactional corpus guidance.

This Binder is a current-context consumption artefact; authoritative masters remain individual files.

## Binder manifest

- `WorkingPractices_Index_v8.md` — sha256 `01e64443b3be`
- `WorkingPractices_Brief_v6.md` — sha256 `956fb127091c`
- `WorkingPractices_Design_v8.md` — sha256 `901a1e3e2333`
- `WorkingPractices_Decisions_v7.md` — sha256 `ba8f2a120e8c`
- `AIDE_WorkingPractices_Standard_v7.md` — sha256 `d7d42141328d`

---

<!-- BEGIN SOURCE: WorkingPractices_Index_v8.md -->
# Working Practices — Index

> **Version 8** (2026-09-02). Registers Working Practices v2 and the Working Context/Handoff/completion model.
>
...
|---|---:|---|---|
| `WorkingPractices_Index` | v7 | Index | Current |
| `WorkingPractices_Brief` | v6 | Brief | Current |
| `WorkingPractices_Design` | v8 | Design | Current |
| `WorkingPractices_Decisions` | v7 | Decisions | Current |
| `AIDE_WorkingPractices_Standard` | v7 | Standard | Current; identity `AIDE_WorkingPractices@v2` |
...
References: WorkingPractices_Design_v8, AIDE_WorkingPractices@v2
<!-- END SOURCE: WorkingPractices_Index_v8.md -->
...
<!-- BEGIN SOURCE: WorkingPractices_Design_v8.md -->
# Working Practices — Design

> **Version 8** (2026-09-02). Makes Working Context selection capability-led, narrows Handoff to genuine transfer boundaries and adds completion/transaction rules.
>
> Created: 2026-08-31 | Last modified: 2026-09-02
...
<!-- END SOURCE: WorkingPractices_Design_v8.md -->

---

<!-- BEGIN SOURCE: WorkingPractices_Decisions_v7.md -->
# Working Practices — Decisions

> **Version 7** (2026-09-02). Records capability-led Working Context, genuine-transfer Handoff, missing-capability and completion rules.
>
> Created: 2026-08-31 | Last modified: 2026-09-02
...
---
Dependencies: !AIDE_DocumentationMethodology@v27, WorkingPractices_Design_v8
References: DocumentationMethodology_Decisions_v19, Principles_Decisions_v3
<!-- END SOURCE: WorkingPractices_Decisions_v7.md -->
