# Capabilities Binder Messaging

> **Generated Binder — do not edit directly.** Edit the individual master documents and regenerate the Binder.
> **Binder Version 6** (2026-09-03). Refreshes the Messaging Capability Definition production vector for the Review D remediated baseline.

This Binder is a current-context consumption artefact; authoritative masters remain individual files.

## Binder manifest

- `Capabilities_Messaging_Definition_v3.md` — sha256 `93c99b101d47`
- `Capabilities_Messaging_Brief_v3.md` — sha256 `b4d39658f6d2`
- `Capabilities_Messaging_Design_v3.md` — sha256 `202e5bfb9dbc`
- `Capabilities_Messaging_Decisions_v2.md` — sha256 `648d08621b13`
- `Capabilities_Messaging_Tool_Design_v2.md` — sha256 `45885bb7b4d4`
- `AIDE_Messaging_Standard_v2.md` — sha256 `83dcdba381b2`
- `AIDE_Messaging_Tool_v2.md` — sha256 `4a137b4aeb28`

---

<!-- BEGIN SOURCE: Capabilities_Messaging_Definition_v3.md -->
# Messaging — Capability Definition

> **Version 3** (2026-09-03). Replaces prose production state with exact evaluated-input checkpoints and aligns the Capability dependency.
...
ElementProduction:
  Messaging.Standard:
    EvaluatedInputs: {Capabilities_Messaging_Design: v3, AIDE_DocumentationMethodology: v28}
    LastEvaluated: 2026-09-03
    Result: CurrentAtElementRelease-v1
  Messaging.Tool:
    EvaluatedInputs: {Capabilities_Messaging_Tool_Design: v2, AIDE_Messaging: v2}
    LastEvaluated: 2026-09-03
    Result: CurrentAtElementRelease-v1
```
...
References: Capabilities_Messaging_Design_v3, AIDE_Messaging@v2, AIDE_MessagingTool@v2
<!-- END SOURCE: Capabilities_Messaging_Definition_v3.md -->

---

<!-- BEGIN SOURCE: Capabilities_Messaging_Brief_v3.md -->
...
<!-- END SOURCE: Capabilities_Messaging_Brief_v3.md -->

---

<!-- BEGIN SOURCE: Capabilities_Messaging_Design_v3.md -->
...
<!-- END SOURCE: Capabilities_Messaging_Design_v3.md -->
...
<!-- BEGIN SOURCE: Capabilities_Messaging_Tool_Design_v2.md -->
# Capabilities Messaging Tool — Design

> **Version 2** (2026-09-01). Aligns the Tool with current Messaging semantics, makes governing executable references versionless, and carries retained-evidence/Ack handling into the action contract.
...
Its job is to construct, parse and manage AI-MESSAGE exchanges according to `AIDE_Messaging`
...
integration. Those implementations preserve this action contract and `AIDE_Messaging`.

No Bootstrap Contribution is required by this Tool Design absent target evidence.

---
Dependencies: !AIDE_DocumentationMethodology@v26, AIDE_Messaging@v2, Capabilities_Tools_Design_v3
References: Capabilities_Messaging_Design, AIDE_Scope
<!-- END SOURCE: Capabilities_Messaging_Tool_Design_v2.md -->
