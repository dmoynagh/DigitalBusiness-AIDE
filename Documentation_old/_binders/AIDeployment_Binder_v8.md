...
> **Binder Version 8** (2026-09-03). Review D R2 closing correction: current Set Release v2 body pointer; Deployment semantics remain v7.

This Binder is a current-context consumption artefact; authoritative masters remain individual files.

## Binder manifest

- `AIDeployment_Index_v8.md` — sha256 `bdf1f9fd20ac`
- `AIDeployment_Design_v8.md` — sha256 `7b27400579e5`
...
<!-- BEGIN SOURCE: AIDeployment_Index_v8.md -->
# AI Deployment — Index
...
<!-- END SOURCE: AIDeployment_Index_v8.md -->

---

<!-- BEGIN SOURCE: AIDeployment_Design_v8.md -->
# AI Deployment — Design

> **Version 8** (2026-09-03). Review D R2 closing correction: points the closed generic layer at the current Set Release v2 contract; Deployment semantics remain v7.
>
...
Detailed contracts: `AIDeployment_SetRelease_Design_v2` and
...
<!-- END SOURCE: AIDeployment_Design_v8.md -->
