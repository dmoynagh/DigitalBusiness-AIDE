...
> **Binder Version 7** (2026-09-02). Closes the Build→Deployment Registry post-Build placeholder using `AIDE_DeploymentRegistryTool@v1`; WorkPackage v3 remains unchanged.

This Binder is a current-context consumption artefact; authoritative masters remain individual files.

## Binder manifest

- `Build_Index_v7.md` — sha256 `5d1348cce1d1`
- `Build_Design_v7.md` — sha256 `d32b305b44ff`
- `Build_Decisions_v7.md` — sha256 `6b1336e84a89`
- `Build_WorkPackage_Design_v3.md` — sha256 `4dfc46fbca2f`
- `AIDE_Build_Standard_v7.md` — sha256 `d86f71ed7c39`
- `AIDE_WorkPackage_Standard_v3.md` — sha256 `b07fe7d6cd5f`
- `Build_PostBuild_Design_v2.md` — sha256 `b773a199d6e8`
- `AIDE_PublishBuildOutput_Tool_v1.md` — sha256 `fc7c8154c1c2`

---

<!-- BEGIN SOURCE: Build_Index_v7.md -->
# Build — Index
...
<!-- END SOURCE: Build_Index_v7.md -->

---

<!-- BEGIN SOURCE: Build_Design_v7.md -->
# Build — Design

> **Version 7** (2026-09-02). Reconciles the post-Build Registry seam to `AIDE_DeploymentRegistryTool@v1` while preserving generic Build ownership.
>
> Created: 2026-08-30 | Last modified: 2026-09-02
...
nominated ordinary filesystem/repository location. AI Deployment owns `AIDE_DeploymentRegistryTool@v1` for publication/registration of validated Deployable Packages into the Deployment Registry.

The WorkPackage/domain build request identifies the nominated post-Build Tool and inputs. For Registry publication, normal use nominates `AIDE_DeploymentRegistryTool@v1` action `Register` with the validated package identity/source, Registry, and optional open Release Batch. The Registry receipt/result is external to immutable package bytes and is reported separately from successful production/validation; failure does not falsely erase the Build result.
...
References: Build_WorkPackage_Design_v3, AIDE_StandardsProduction@v3, ProjectDesign_Design_v5, Build_PostBuild_Design_v2, AIDE_DeploymentRegistryTool@v1
<!-- END SOURCE: Build_Design_v7.md -->

---

<!-- BEGIN SOURCE: Build_Decisions_v7.md -->
# Build — Decisions

> **Version 7** (2026-09-02). Records closure of the AI Deployment Registry post-Build Tool seam.
>
> Created: 2026-08-30 | Last modified: 2026-09-02
...
---
Dependencies: !AIDE_DocumentationMethodology@v27, Build_Design_v7
References: ProjectDesign_Design_v2, AIDE_Deployment@v5, AIDE_DeploymentRegistryTool@v1, AIDE_WorkPackage@v3
<!-- END SOURCE: Build_Decisions_v7.md -->
...
<!-- BEGIN SOURCE: AIDE_Build_Standard_v7.md -->
# AIDE Build — Standard

> **Identity:** `AIDE_Build@v7`
> **Common name:** Build
> **Version 7** (2026-09-02). Resolves Deployment Registry registration to `AIDE_DeploymentRegistryTool@v1` while preserving Build/post-Build separation.
>
...
---
Dependencies: !AIDE_DocumentationMethodology@v27, Build_Design_v7, AIDE_Review@v3
References: AIDE_WorkPackage@v3, AIDE_StandardsProduction@v3, AIDE_PublishBuildOutputTool@v1, AIDE_DeploymentRegistryTool@v1
<!-- END SOURCE: AIDE_Build_Standard_v7.md -->
...
<!-- BEGIN SOURCE: Build_PostBuild_Design_v2.md -->
...
<!-- END SOURCE: Build_PostBuild_Design_v2.md -->
